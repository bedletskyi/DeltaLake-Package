...
SqlBaseVisitor.prototype.visitAnalyzeTables = function (ctx) {
	return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitShowTableExtended = function (ctx) {
	return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitConfigValue = function (ctx) {
	return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitGroupByClause = function (ctx) {
	return this.visitChildren(ctx);
};

// Visit a parse tree produced by SqlBaseParser#groupingAnalytics.
SqlBaseVisitor.prototype.visitGroupingAnalytics = function (ctx) {
	return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitPartitionFieldList = function (ctx) {
	return this.visitChildren(ctx);
};

// Visit a parse tree produced by SqlBaseParser#partitionTransform.
SqlBaseVisitor.prototype.visitPartitionTransform = function (ctx) {
	return this.visitChildren(ctx);
};

// Visit a parse tree produced by SqlBaseParser#partitionColumn.
SqlBaseVisitor.prototype.visitPartitionColumn = function (ctx) {
	return this.visitChildren(ctx);
};
