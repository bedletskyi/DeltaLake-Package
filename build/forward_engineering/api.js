'use strict';
var o = (e, p) => () => (p || e((p = { exports: {} }).exports, p), p.exports);
var q = o((so, m2) => {
	var r2 = {},
		Z0 = e => {
			r2.lodash = e.require('lodash');
		};
	m2.exports = { setDependencies: Z0, dependencies: r2 };
});
var s2 = o((oo, l2) => {
	var e9 = [
		'user',
...
var W = o((no, c2) => {
	...
	var p9 = s2(),
		...
		o2 = ({ lodash: e }) => (a9 = e),
		d9 = (e, p) => {
			let a = (...i) => i.reduce((r, m) => r + m, e),
				d = (...i) => (i.length ? ((a = a.bind(null, t(...i))), d) : u2(a(), p)),
				t = (i, r) =>
					i && r === ')'
						? `
)`
...
` + n2(r)
		...
		i9 = (e = '') =>
			/\s/g.test(e) && !t9(e)
				? `\`${e}\``
				: p9.includes(e.toLowerCase())
				? `\`${e}\``
				: isNaN(e)
				? e
				: `\`${e}\``,
		r9 = (e = '') => e.replace(/\s/g, '_'),
		m9 = e => e.code || e.collectionName || e.name || '',
		l9 = (e, p) => (Array.isArray(p) ? p[e] || {} : {}),
		n2 = (e, p = 4) =>
			(e || '')
				.split(
					`
`,
				...
				.map(a => ' '.repeat(p) + a).join(`
`),
		re = {},
		s9 = e => {
			if (re[e]) return re[e];
			try {
				return (re[e] = require(`../../types/${e}.json`)), re[e];
			} catch {
				return {};
			}
		},
...
`))(e, '-- '),
		o9 = (e, p) => {
			o2(me);
			let [a, d] = me.lodash.partition(e, t => !(p.has(t) || p.has(t.slice(1, -1))));
			return a.length === 0
				? { isAllKeysDeactivated: !0, keysString: d.join(', ') }
				: d.length === 0
				? { isAllKeysDeactivated: !1, keysString: a.join(', ') }
				: { isAllKeysDeactivated: !1, keysString: `${a.join(', ')} /*, ${d.join(', ')} */` };
		},
		n9 = e => {
			o2(me);
			let p = e.split(`
`);
			if (p.length < 4 || !p[p.length - 2].trim().startsWith('--')) return e;
			let a = me.lodash.findLastIndex(p, d => {
				if (d.trim() !== ');' && !d.trim().startsWith('--')) return !0;
			});
			return a !== -1
				? ((p[a] = `${p[a].slice(0, -1)} -- ,`),
				  p.join(`
`))
		...
		u9 = e => (e.endsWith('/') ? e.slice(0, -1) : e),
		c9 = (e = '') => e.replace(/(')/gi, '\\$1').replace(/\n/gi, '\\n');
	c2.exports = {
		buildStatement: d9,
		getName: m9,
		getTab: l9,
		indentString: n2,
		getTypeDescriptor: s9,
		prepareName: i9,
		replaceSpaceWithUnderscore: r9,
		commentDeactivatedStatements: u2,
		commentDeactivatedInlineKeys: o9,
		removeRedundantTrailingCommaFromStatement: n9,
		getCleanedUrl: u9,
		encodeStringLiteral: c9,
	};
});
var We = o((uo, T2) => {
	'use strict';
	var { buildStatement: v9, getName: v2, getTab: f2, replaceSpaceWithUnderscore: E2, encodeStringLiteral: f9 } = W(),
		E9 = ({ name: e, comment: p, location: a, dbProperties: d, isActivated: t }) =>
			v9(`CREATE DATABASE IF NOT EXISTS ${e}`, t)(p, `COMMENT '${f9(p)}'`)(a, `LOCATION '${a}'`)(
				d,
				`WITH DBPROPERTIES (${d})`,
			)(!0, ';')(),
		T9 = e => {
		...
		h9 = e => {
			let p = f2(0, e);
			if (!p.dbProperties) return '';
			let a = E2(v2(p));
			return a
				? `ALTER DATABASE ${a} SET DBPROPERTIES (${p.dbProperties});

`
				: '';
		};
	T2.exports = { getDatabaseStatement: T9, getDatabaseAlterStatement: h9 };
});
var Ke = o((co, D2) => {
	'use strict';
	var {
			replaceSpaceWithUnderscore: N9,
			getName: Xe,
			getTypeDescriptor: h2,
			prepareName: le,
			commentDeactivatedStatements: S9,
			encodeStringLiteral: N2,
		} = W(),
		je = (e, p, a) => `${le(e)}: ${p}` + (a ? ` COMMENT '${N2(a)}'` : ''),
		w9 = (e, p) => a => {
			let d = Object.keys(a.properties || {}),
				t = [],
				i = [];
			if (
				(d.length &&
					d.forEach(r => {
						let m = a.properties[r],
							l = Xe(m) || r,
							s = m.isActivated !== !1,
							n = je(l, e(m), g2(p, m));
						s ? t.push(n) : i.push(n);
				...
				let r = x1(e)(a);
				t.push(...Object.keys(r).map(m => je(m, r[m])));
			}
			if (Array.isArray(a.allOf)) {
				let r = se(e)(a);
				t.push(...Object.keys(r).map(m => je(m, r[m])));
			}
			return t.length || t.push('new_column: string'), { activatedProps: t, deactivatedProps: i };
		},
		A9 = (e, p) => a => {
			let d = r => `struct<${r}>`,
				{ activatedProps: t, deactivatedProps: i } = w9(e, p)(a);
			return i.length === 0
				? d(t.join(', '))
				: t.length === 0
				? d(`/* ${t.join(', ')} */`)
		...
		S2 = (e, p) => {
			let a = ((h2(e).subtypes || {})[p] || {}).childValueType || 'text';
			return w2(a);
		},
		w2 = e => {
			let p = h2(e);
			return Object.assign({ type: e }, p.defaultValues || {});
		},
		R9 = e => p => {
			let a;
			if (Array.isArray(p.items)) a = e(p.items[0]);
			else if (p.items) a = e(p.items);
			...
			return a || (a = e(S2('array', p.subtype))), `array<${a}>`;
		},
		g9 = e =>
			['char', 'varchar'].indexOf(e.keySubtype) !== -1
				? e.keySubtype + '(255)'
				: e.keySubtype
				? e.keySubtype
				: e.keyType === 'numeric'
		...
		D9 = e => p => {
			let a = g9(p),
				d = Object.keys(p.properties || {}),
				t;
			if (d.length) t = e(p.properties[d[0]]);
			else if (Array.isArray(p.oneOf)) {
				let i = x1(e)(p);
				t = i[Object.keys(i)[0]];
			} else if (Array.isArray(p.allOf)) {
			...
			return t || (t = e(S2('map', p.subtype))), `map<${a}, ${t}>`;
		},
		O9 = e => {
			let p = e.mode;
			return ['char', 'varchar'].indexOf(p) === -1
				? 'string'
				: e.maxLength
				? p + `(${e.maxLength})`
				: p + `(${255})`;
		...
		_9 = e => {
			let p = e.mode;
			return p !== 'decimal' ? p : e.precision || e.scale ? p + `(${e.precision || 9}, ${e.scale || 0})` : p;
		},
		I9 = e => p => p.physicalType ? e(Object.assign({}, p, { type: p.physicalType })) : 'string',
		C9 = e => p => `uniontype<${p.type.map(d => e(w2(d === 'number' ? 'numeric' : d))).join(',')}>`,
		x1 = e => p => {
			let a = p.oneOf.reduce(
				(d, t) =>
					Object.keys(t.properties || {}).reduce((i, r) => {
						let m = t.properties[r],
							l = Xe(m) || r,
							s = e(m);
						return Array.isArray(i[l]) || (i[l] = []), i[l].push(s), i;
					}, d),
				{},
			);
			return Object.keys(a).reduce((d, t) => ((d[t] = `uniontype<${(a[t] || []).join(', ')}>`), d), {});
		},
		se = e => p => p.allOf.reduce((a, d) => (Array.isArray(d.oneOf) ? Object.assign({}, a, x1(e)(d)) : a), {}),
		A2 = (e, p) => {
			let a = p.$ref.split('/'),
				d = a[a.length - 1],
				t = {};
			...
			let i = t.properties || {};
			return i[d] ? i[d] : e.reduce((m, { properties: l }) => ({ ...m, ...(l || {}) }), {})[d] || d;
		},
		m1 =
			(e = []) =>
			p => {
				if (Array.isArray(p.type)) return C9(m1(e))(p);
				switch ((p.$ref && (p = A2(e, p)), p.type)) {
					case 'jsonObject':
					case 'jsonArray':
						return I9(m1(e))(p);
					case 'text':
		...
		Ye = (e, p, a, d, t) => ({ [e]: { type: p, comment: a, constraints: d, isActivated: t } }),
		y9 = (e, p, a) => {
			let d = new Set(),
				t = Object.keys(e.properties || {}).reduce((i, r) => {
					let m = e.properties[r],
						l = (e.required || []).includes(r),
						s = Xe(m) || r;
					return (
						m.isActivated || d.add(s),
						Object.assign(
							{},
							i,
							Ye(
								...
								m1(a)(m),
								g2(a, m),
								p ? { notNull: l, unique: m.unique, check: m.check, defaultValue: m.default } : {},
								m.isActivated,
							),
						)
					);
			...
			if (Array.isArray(e.oneOf)) {
				let i = x1(m1(a))(e);
				t = Object.keys(i).reduce((r, m) => Object.assign({}, r, Ye(le(m), i[m])), t);
			}
			if (Array.isArray(e.allOf)) {
				let i = se(m1(a))(e);
				t = Object.keys(i).reduce((r, m) => Object.assign({}, r, Ye(le(m), i[m])), t);
			}
			return { columns: t, deactivatedColumnNames: d };
		},
		R2 = ({ name: e, type: p, comment: a, constraints: d, isActivated: t, isParentActivated: i }) => {
			let r = a ? ` COMMENT '${N2(a)}'` : '',
				m = d ? b9(d) : '',
				l = i ? t : !0;
			return S9(`${N9(e)} ${p}${m}${r}`, l);
		},
		L9 = (e, p) =>
			Object.keys(e)
				.map(a => R2(Object.assign({}, e[a], { name: a, isParentActivated: p })))
				.join(', '),
		b9 = ({ notNull: e, unique: p, check: a, defaultValue: d }) => {
			let i = [e && !p ? 'NOT NULL' : ''].filter(Boolean).join(' ');
			return i ? ` ${i}` : '';
		},
		g2 = (e, p) => {
			if (!p.$ref) return p.description;
			let a = A2(e, p)?.description;
			return p.refDescription || p.description || a;
		};
	D2.exports = { getColumns: y9, getColumnsStatement: L9, getColumnStatement: R2 };
});
var ne = o((vo, _2) => {
	'use strict';
	var { getName: V9, prepareName: ze } = W(),
		A1 = (e, p, a) => {
			if (e.GUID === p) return a;
			if (e.properties)
				return Object.keys(e.properties).reduce(
					(d, t) => d || A1(e.properties[t], p, [...a, e.properties[t].GUID]),
					void 0,
				);
			if (e.items)
				return Array.isArray(e.items)
					? e.items.reduce((d, t) => d || A1(t, p, [...a, t.GUID]), void 0)
					: A1(e.items, p, [...a, e.items.GUID]);
		},
		P9 = (e, p) => {
			let a = Object.keys(p).find(d => p[d].GUID === e);
			return p[a] && p[a].code ? ze(p[a].code) : ze(a);
		},
		U9 = (e, p) => {
			let a = A1(p, e, []);
			return a ? P9(a[0], p.properties) : '';
		},
		M9 = (e, p) =>
			e.reduce((a, d) => {
				for (let t = 0; t < p.length; t++) {
					let i = U9(d, p[t]);
					if (i) return Object.assign({}, a, { [d]: i });
				}
				return a;
			}, {}),
		B9 = (e, p) =>
		...
		oe = (e, p, a) => {
			if (e.properties)
				return Object.keys(e.properties).forEach((d, t) => {
					let i = [...p, e.properties[d].GUID];
					a(d, e.properties[d], i), oe(e.properties[d], i, a);
				});
			if (e.items)
				return (Array.isArray(e.items) ? e.items : [e.items]).forEach((t, i) => {
					let r = [...p, t.GUID];
					a(i, t, r), oe(t, r, a);
				});
		},
		...
		x9 = (e, p) => {
			let a = p.map(d => (e[d] instanceof Number ? '$elem$' : e[d])).join('.');
			return ze(a);
		},
		k9 = e => {
			let p = [];
		...
		O2 = (e, p) => {
			...
			return (
				p.properties
					? (a = Object.values(p.properties).find(d => d.GUID === e[0]))
					: p.items && (Array.isArray(p.items) ? (a = p.items.find(d => d.GUID === e[0])) : (a = p.items)),
				a ? (e.length === 1 ? a : O2(e.slice(1), a)) : null
			);
		};
	_2.exports = {
		getPathById: A1,
...
var C2 = o((fo, I2) => {
	'use strict';
	var ue = ne(),
		ce = (e, p) => p.filter(a => e.find(d => a[a.length - 1] === d.keyId)),
		q9 = e => (p, a) =>
			p.map(d => {
				let t = a.find(i => i[i.length - 1] === d.keyId) || [];
				return { name: e(t), type: d.type === 'ascending' ? 'ASC' : 'DESC' };
			}),
		$9 = (e, p, a) => {
			let d = e.compositeClusteringKey || [],
				t = e.compositePartitionKey || [],
				i = e.skewedby || [],
				r = e.sortedByKey || [],
				m = [...d, ...t, ...i, ...r].map(c => c.keyId),
				l = ue.getPathsByIds(m, [p, ...a]),
				s = ue.getPrimaryKeys(p).filter(c => !l.find(v => v[v.length - 1] === c[c.length - 1])),
				n = ue.getIdToNameHashTable([p, ...a]),
				u = ue.getNameByPath.bind(null, n);
			return {
				primaryKeys: s.map(u),
				compositeClusteringKey: ce(d, l).map(u),
				compositePartitionKey: ce(t, l).map(u),
				skewedby: ce(i, l).map(u),
				sortedByKey: q9(u)(r, ce(r, l)),
			};
		};
	I2.exports = { getKeyNames: $9 };
});
var Qe = o((ho, U2) => {
	'use strict';
	var {
			...
			getTab: Je,
			indentString: Eo,
			replaceSpaceWithUnderscore: L2,
			commentDeactivatedInlineKeys: b2,
			removeRedundantTrailingCommaFromStatement: G9,
			encodeStringLiteral: V2,
		} = W(),
		{ getColumnsStatement: H9, getColumnStatement: To, getColumns: W9 } = Ke(),
		j9 = C2(),
		{ dependencies: Y9 } = q(),
		ve,
		X9 = ({ lodash: e }) => (ve = e),
		K9 = ({
			...
			likeStatement: i,
			columnStatement: r,
			primaryKeyStatement: m,
			foreignKeyStatement: l,
			comment: s,
			partitionedByKeys: n,
			clusteredKeys: u,
			sortedKeys: c,
		...
		z9 = ({
			...
			k1(`CREATE${e}TABLE IF NOT EXISTS ${p} (`, v)(d, d + (t ? ',' : ''))(!0, ')')(a, `USING ${P2(a)}`)(
				r,
				`PARTITIONED BY (${r})`,
			)(m, `CLUSTERED BY (${m})`)(l && m, `SORTED BY (${l})`)(s && m, `INTO ${s} BUCKETS`)(n, `LOCATION '${n}'`)(
				i,
				`COMMENT '${V2(i)}'`,
			)(u, `TBLPROPERTIES ${u}`)(c, `AS ${c}`)(!0, ';')(),
		J9 = ({
			tempExtStatement: e,
			fullTableName: p,
			columnStatement: a,
			primaryKeyStatement: d,
			foreignKeyStatement: t,
			comment: i,
			partitionedByKeys: r,
			rowFormatStatement: m,
			storedAsStatement: l,
			location: s,
			tableProperties: n,
			selectStatement: u,
			...
			let v = a || d || t;
			return k1(`CREATE${e}TABLE IF NOT EXISTS ${p} `, c)(v, '(')(a, a + (d ? ',' : ''))(d, d)(t, t)(v, ')')(
				i,
				`COMMENT '${V2(i)}'`,
			)(r, `PARTITIONED BY (${r})`)(m, `ROW FORMAT ${m}`)(l, l)(s, `LOCATION '${s}'`)(n, `TBLPROPERTIES ${n}`)(
				u,
				`AS ${u}`,
			)(!0, ';')();
		},
		Q9 = ({
			...
			columnStatement: d,
			primaryKeyStatement: t,
			foreignKeyStatement: i,
			rowFormatStatement: r,
			storedAsStatement: m,
			location: l,
			tableProperties: s,
			isActivated: n,
		}) =>
			k1(`CREATE${e}TABLE IF NOT EXISTS ${p} (`, n)(d, d + (t ? ',' : ''))(t, t)(i, i)(!0, ')')(
				a,
				`USING '${P2(a)}'`,
			)(r, `ROW FORMAT ${r}`)(m, m)(s, `TBLPROPERTIES ${s}`)(l, `LOCATION '${l}'`)(!0, ';')(),
		Z9 = (e, p, a) => {
			if (!Array.isArray(e) || !e.length) return '';
			if (!a) return e.join(', ');
			let { keysString: d } = b2(e, p);
			return d;
		},
		e3 = (e, p, a) => {
			let d = r => r.map(m => `${m.name} ${m.type}`).join(', ');
			if (!Array.isArray(e) || !e.length) return '';
			let [t, i] = ve.partition(e, r => !p.has(r.name));
			return !a || i.length === 0 ? d(e) : t.length === 0 ? `/* ${d(i)} */` : `${d(t)} /*, ${d(i)} */`;
		},
		p3 = (e, p, a) => {
			let d = r => (a === 'Hive' ? r.map(m => `${m.name} ${m.type}`).join(', ') : r.map(m => m.name).join(', '));
			if (!Array.isArray(e) || !e.length) return '';
			let [t, i] = ve.partition(e, r => r.isActivated);
			return !p || i.length === 0 ? d(e) : t.length === 0 ? `/* ${d(e)} */` : `${d(t)} /*, ${d(t)} */`;
		},
		a3 = (e, p) => p.map(a => Object.assign({}, e[a] || { type: 'string' }, { name: a })).filter(a => a),
		d3 = (e, p) => p.reduce((a, d) => (delete a[d], a), Object.assign({}, e)),
		t3 = (e, p, a) => (p === 'Hive' ? d3(e, a) : e),
		i3 = (e, p, a, d, t) => {
			let i = l => `SKEWED BY (${l}) ON ${p} ${a ? 'STORED AS DIRECTORIES' : ''}`;
			if (!Array.isArray(e) || !e.length) return '';
			if (!t) return i(e.join(', '));
			let { isAllKeysDeactivated: r, keysString: m } = b2(e, d);
			return r ? '-- ' + i(m) : i(m);
		},
		r3 = e => {
			if (e.storedAsTable !== 'textfile') return '';
			if (e.rowFormat === 'delimited')
				return k1('DELIMITED')(e.fieldsTerminatedBy, `FIELDS TERMINATED BY '${e.fieldsTerminatedBy}'`)(
					e.fieldsescapedBy,
					`ESCAPED BY '${e.fieldsescapedBy}'`,
				)(e.collectionItemsTerminatedBy, `COLLECTION ITEMS TERMINATED BY '${e.collectionItemsTerminatedBy}'`)(
					e.mapKeysTerminatedBy,
					`MAP KEYS TERMINATED BY '${e.mapKeysTerminatedBy}'`,
				)(e.linesTerminatedBy, `LINES TERMINATED BY '${e.linesTerminatedBy}'`)(
					e.nullDefinedAs,
					`NULL DEFINED AS '${e.nullDefinedAs}'`,
				)();
			if (e.rowFormat === 'SerDe')
				return k1(`SERDE '${e.serDeLibrary}'`)(
					e.serDeProperties,
					`WITH SERDEPROPERTIES (${e.serDeProperties})`,
				)();
		},
		m3 = e => {},
		l3 = e => {
			if (!e.storedAsTable) return '';
			if (e.storedAsTable === 'input/output format') {
				let p = [];
				return (
					e.serDeLibrary && p.push(`ROW FORMAT SERDE '${e.serDeLibrary}'`),
					p.push(`STORED AS INPUTFORMAT '${e.inputFormatClassname}'`),
					p.push(`OUTPUTFORMAT '${e.outputFormatClassname}'`),
					p.join(`
`)
				);
			}
			return `STORED AS ${e.storedAsTable.toUpperCase()}`;
		},
		s3 = (e, p, a, d, t) => {
			X9(Y9);
			let i = L2(y2(Je(0, e))),
				r = Je(0, p),
				m = Je(0, e),
				l = r.isActivated && (typeof m.isActivated == 'boolean' ? m.isActivated : !0),
				s = L2(y2(r)),
				{ columns: n, deactivatedColumnNames: u } = W9(a, t, d),
				c = j9.getKeyNames(r, a, d),
				v = t3(n, r.using, c.compositePartitionKey),
				f = K9({
					dbName: i,
					tableName: s,
					isTemporary: r.temporaryTable,
					isExternal: r.externalTable,
					using: r.using,
					likeStatement: m3(r.like),
					columnStatement: H9(v, l),
					comment: r.description,
					partitionedByKeys: p3(a3(n, c.compositePartitionKey), l, r.using),
					clusteredKeys: Z9(c.compositeClusteringKey, u, l),
					sortedKeys: e3(c.sortedByKey, u, l),
					numBuckets: r.numBuckets,
					skewedStatement: i3(c.skewedby, r.skewedOn, r.skewStoredAsDir, u, l),
					rowFormatStatement: r3(r),
					storedAsStatement: l3(r),
					location: r.location,
					tableProperties: r.tableProperties,
					selectStatement: '',
					isActivated: l,
				}),
				h = Object.keys(n)
					.map(T => ({ colName: T.replaceAll('`', ''), ...n[T] }))
					.filter(T => T.constraints.check)
					.map(
						T =>
							`ALTER TABLE ${s} ADD CONSTRAINT \`${T.colName}_constraint\` CHECK (${T.constraints.check})`,
					).join(`;
`);
			return (
				ve.isEmpty(h) ||
...
`),
	...
	U2.exports = { getTableStatement: s3 };
});
var dp = o((No, F2) => {
	'use strict';
	var { getTab: Ze, buildStatement: o3, prepareName: n3, getName: M2, replaceSpaceWithUnderscore: pp } = W(),
		ep = ne(),
		{ getItemByPath: u3 } = ne(),
		{ dependencies: B2 } = q(),
		ap,
		c3 = ({ lodash: e }) => (ap = e),
		v3 = ({ tableName: e, dbName: p, columns: a, options: d, isActivated: t }) =>
			o3(`CREATE BLOOMFILTER INDEX ON TABLE ${p}.${e} FOR COLUMNS (${a})`, t)(d, `OPTIONS (${d})`)(!0, ';')(),
		f3 = (e, p, a) => {
			if (!Array.isArray(e)) return '';
			let d = ep.getPathsByIds(
					e.map(s => s.keyId),
					[p, ...a],
				),
				t = ep.getIdToNameHashTable([p, ...a]),
				[i, r] = B2.lodash.partition(d, s => {
					let n = u3(s, p);
					return n ? n.isActivated : !0;
				}),
				m = s => s.map(n => n3(pp(ep.getNameByPath(t, n)))).join(', '),
				l = m(d);
			return r.length === 0
				? { isIndexActivated: !0, columns: l }
				: i.length === 0
				? { isIndexActivated: !1, columns: l }
				: { isIndexActivated: !0, columns: `${m(i)} /*, ${m(r)}*/` };
		},
		E3 = (e, p, a, d) => {
			c3(B2);
			let t = Ze(0, e),
				...
				l = pp(M2(r));
			return m
				.filter(s => !ap.isEmpty(s.forColumns))
				.map(s => {
					let { columns: n, isIndexActivated: u = !0 } = f3(s.forColumns, a, d);
					return v3({
						dbName: i || 'default',
						tableName: l,
						columns: n,
						options: s.options,
						isActivated: u && r.isActivated && (ap.isEmpty(t) || t.isActivated),
					});
				}).join(`

`);
		};
	F2.exports = { getIndexes: E3 };
});
var tp = o((So, $2) => {
	'use strict';
	var F,
		{ dependencies: T3 } = q(),
		{ prepareName: l1, encodeStringLiteral: x2 } = W(),
		h3 = ({ lodash: e }) => (F = e),
		N3 = (e, p) =>
			F.uniq(
				Object.keys(p).map(a => {
					let d = F.get(p, [a, 'GUID']),
						t = Object.keys(e).find(l => e[l].definitionId === d),
						i = e[t] || {};
					if (!i.name || i.name === a) return l1(i.name);
					let r = F.first(i.collection) || {},
						m = r.collectionName || r.code;
					return `${l1(m)}.${l1(i.name)} as ${l1(a)}`;
				}),
			).filter(F.identity),
		S3 = (e, p) => {
			let a = F.uniq(
				Object.keys(p).map(d => {
					let t = p[d].refId,
						i = e[t],
						r = F.first(i.collection) || {},
						m = F.first(i.bucket) || {},
						l = l1(r.collectionName || r.code),
						s = l1(m.name || m.code || '');
					return s ? `${s}.${l}` : `${l}`;
				}),
			);
			return F.isEmpty(a) ? '' : 'FROM ' + a.join(' INNER JOIN ');
		},
		k2 = (e, p, a, d = '') => ((e || [])[p] || {})[a] || d,
		w3 = e => k2(e, 0, 'code', k2(e, 0, 'name', '')),
		q2 = (e = '') => e.replace(/\s/g, '_');
	$2.exports = {
		getViewScript({ schema: e, viewData: p, containerData: a, collectionRefsDefinitionsMap: d }) {
			h3(T3);
			let t = [],
				i = e.properties || {},
				r = F.first(p) || {},
				m = q2(l1(w3(a))),
				l = q2(l1(r.code || r.name)),
				s = e.viewGlobal && e.viewTemporary,
				n = e.viewTemporary,
				u = e.viewOrReplace,
				c = S3(d, i),
				v = m ? `${m}.${l}` : `${l}`,
				f = `CREATE ${u ? 'OR REPLACE ' : ''}${s ? 'GLOBAL ' : ''}${
					n ? 'TEMPORARY ' : ''
				}VIEW IF NOT EXISTS ${v}`,
				h = e.description;
			if ((t.push(f), e.selectStatement))
				return (
					f +
					`${h ? " COMMENT '" + x2(h) + "'" : ''} AS ${e.selectStatement};

`
				);
			if (!F.isEmpty(i)) {
				if ((h && t.push(`COMMENT '${x2(h)}'`), !F.isEmpty(i))) {
					let T = N3(d, i);
					t.push(`AS SELECT ${T.join(', ')}`), t.push(c);
				}
				return (
					t.join(`
  `) +
...
var W2 = o((wo, H2) => {
	...
	function s1(e, p) {
		p.unsigned || --e;
		let a = p.unsigned ? 0 : -Math.pow(2, e),
			d = Math.pow(2, e) - 1,
		...
		return function (r, m) {
			...
			if (m.enforceRange) {
				...
				if (((l = G2(l) * Math.floor(Math.abs(l))), l < a || l > d))
					throw new TypeError('Argument is not in byte range');
				return l;
			}
			if (!isNaN(l) && m.clamp) return (l = A3(l)), l < a && (l = a), l > d && (l = d), l;
			if (!Number.isFinite(l) || l === 0) return 0;
			if (((l = G2(l) * Math.floor(Math.abs(l))), (l = l % t), !p.unsigned && l >= i)) return l - t;
			if (p.unsigned) {
				if (l < 0) l += t;
	...
	A.byte = s1(8, { unsigned: !1 });
	A.octet = s1(8, { unsigned: !0 });
	A.short = s1(16, { unsigned: !1 });
	A['unsigned short'] = s1(16, { unsigned: !0 });
	A.long = s1(32, { unsigned: !1 });
	A['unsigned long'] = s1(32, { unsigned: !0 });
	A['long long'] = s1(32, { unsigned: !1, moduloBitLength: 64 });
	A['unsigned long long'] = s1(32, { unsigned: !0, moduloBitLength: 64 });
	A.double = function (e) {
		let p = +e;
	...
	A.DOMString = function (e, p) {
		return p || (p = {}), p.treatNullAsEmptyString && e === null ? '' : String(e);
	};
	A.ByteString = function (e, p) {
		let a = String(e),
			d;
		for (let t = 0; (d = a.codePointAt(t)) !== void 0; ++t)
	...
	A.USVString = function (e) {
		let p = String(e),
			...
			d = [];
		for (let t = 0; t < a; ++t) {
			let i = p.charCodeAt(t);
			if (i < 55296 || i > 57343) d.push(String.fromCodePoint(i));
			else if (56320 <= i && i <= 57343) d.push(String.fromCodePoint(65533));
			else if (t === a - 1) d.push(String.fromCodePoint(65533));
			else {
				let r = p.charCodeAt(t + 1);
				if (56320 <= r && r <= 57343) {
					let m = i & 1023,
						l = r & 1023;
					d.push(String.fromCodePoint((2 << 15) + (2 << 9) * m + l)), ++t;
	...
	A.RegExp = function (e, p) {
		return e instanceof RegExp || (e = new RegExp(e)), e;
	};
});
var j2 = o((Ao, o1) => {
	'use strict';
	o1.exports.mixin = function (p, a) {
		let d = Object.getOwnPropertyNames(a);
		for (let t = 0; t < d.length; ++t) Object.defineProperty(p, d[t], Object.getOwnPropertyDescriptor(a, d[t]));
	};
	o1.exports.wrapperSymbol = Symbol('wrapper');
	o1.exports.implSymbol = Symbol('impl');
	o1.exports.wrapperForImpl = function (e) {
		return e[o1.exports.wrapperSymbol];
	};
	o1.exports.implForWrapper = function (e) {
		return e[o1.exports.implSymbol];
	};
});
var Y2 = o((Ro, R3) => {
	R3.exports = [
...
var Z2 = o((go, Ee) => {
	'use strict';
	var K2 = require('punycode'),
		X2 = Y2(),
		R1 = { TRANSITIONAL: 0, NONTRANSITIONAL: 1 };
	function z2(e) {
		return e
			.split('\0')
			.map(function (p) {
	...
	var g3 = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
	function Q2(e) {
		return e.replace(g3, '_').length;
	}
	function D3(e, p, a) {
		for (var d = !1, t = '', i = Q2(e), r = 0; r < i; ++r) {
			var m = e.codePointAt(r),
				l = J2(m);
			switch (l[1]) {
				case 'disallowed':
					(d = !0), (t += String.fromCodePoint(m));
					break;
				case 'ignored':
					break;
				case 'mapped':
					t += String.fromCodePoint.apply(String, l[2]);
					break;
				case 'deviation':
					a === R1.TRANSITIONAL
						? (t += String.fromCodePoint.apply(String, l[2]))
						: (t += String.fromCodePoint(m));
					break;
				case 'valid':
					t += String.fromCodePoint(m);
					break;
				case 'disallowed_STD3_mapped':
					p ? ((d = !0), (t += String.fromCodePoint(m))) : (t += String.fromCodePoint.apply(String, l[2]));
					break;
				case 'disallowed_STD3_valid':
					p && (d = !0), (t += String.fromCodePoint(m));
					break;
			}
		}
	...
	function _3(e, p) {
		e.substr(0, 4) === 'xn--' && ((e = K2.toUnicode(e)), (p = R1.NONTRANSITIONAL));
		var a = !1;
		(z2(e) !== e ||
			(e[3] === '-' && e[4] === '-') ||
			e[0] === '-' ||
			...
			e.search(O3) === 0) &&
			(a = !0);
		for (var d = Q2(e), t = 0; t < d; ++t) {
			var i = J2(e.codePointAt(t));
			if (
				(fe === R1.TRANSITIONAL && i[1] !== 'valid') ||
				(fe === R1.NONTRANSITIONAL && i[1] !== 'valid' && i[1] !== 'deviation')
			) {
				a = !0;
				break;
			}
	...
	function fe(e, p, a) {
		var d = D3(e, p, a);
		d.string = z2(d.string);
		for (var t = d.string.split('.'), i = 0; i < t.length; ++i)
			try {
				var r = _3(t[i]);
	...
	Ee.exports.toASCII = function (e, p, a, d) {
		var t = fe(e, p, a),
			i = t.string.split('.');
		if (
			((i = i.map(function (l) {
	...
	Ee.exports.toUnicode = function (e, p) {
		var a = fe(e, p, R1.NONTRANSITIONAL);
		return { domain: a.string, error: a.error };
	};
	Ee.exports.PROCESSING_OPTIONS = R1;
});
var j = o((Do, P) => {
	'use strict';
	var g1 = require('punycode'),
		ea = Z2(),
		ta = { ftp: 21, file: null, gopher: 70, http: 80, https: 443, ws: 80, wss: 443 },
		E = Symbol('failure');
	function pa(e) {
		return g1.ucs2.decode(e).length;
	}
	function aa(e, p) {
		let a = e[p];
	...
	function $(e) {
		return q1(e) || (e >= 65 && e <= 70) || (e >= 97 && e <= 102);
	}
	function da(e) {
	...
	function y3(e, p) {
		return $1(e) && (p === 58 || p === 124);
	}
	function ia(e) {
		return e.length === 2 && $1(e.codePointAt(0)) && (e[1] === ':' || e[1] === '|');
	}
	function L3(e) {
		return e.length === 2 && $1(e.codePointAt(0)) && e[1] === ':';
	}
	function b3(e) {
		return e.search(/\u0000|\u0009|\u000A|\u000D|\u0020|#|%|\/|:|\?|@|\[|\\|\]/) !== -1;
	}
	...
	function U3(e) {
		let p = new Buffer(e),
			a = '';
		for (let d = 0; d < p.length; ++d) a += ra(p[d]);
		return a;
	}
	function M3(e) {
		let p = new Buffer(e),
		...
		for (let d = 0; d < p.length; ++d)
			p[d] !== 37
				? a.push(p[d])
				: p[d] === 37 && $(p[d + 1]) && $(p[d + 2])
				? (a.push(parseInt(p.slice(d + 1, d + 3).toString(), 16)), (d += 2))
				: a.push(p[d]);
	...
	var B3 = new Set([32, 34, 35, 60, 62, 63, 96, 123, 125]);
	function ma(e) {
		return Te(e) || B3.has(e);
	}
	var F3 = new Set([47, 58, 59, 61, 64, 91, 92, 93, 94, 124]);
	function mp(e) {
		return ma(e) || F3.has(e);
	}
	function h1(e, p) {
	...
	function x3(e) {
		...
		return (
			e.length >= 2 && e.charAt(0) === '0' && e.charAt(1).toLowerCase() === 'x'
				? ((e = e.substring(2)), (p = 16))
				: e.length >= 2 && e.charAt(0) === '0' && ((e = e.substring(1)), (p = 8)),
			e === '' ? 0 : (p === 10 ? /[^0-9]/ : p === 16 ? /[^0-9A-Fa-f]/ : /[^0-7]/).test(e) ? E : parseInt(e, p)
		);
	}
	function k3(e) {
		let p = e.split('.');
		...
		for (let i = 0; i < a.length - 1; ++i) if (a[i] > 255) return E;
		if (a[a.length - 1] >= Math.pow(256, 5 - a.length)) return E;
		let d = a.pop(),
			t = 0;
		for (let i of a) (d += i * Math.pow(256, 3 - t)), ++t;
		return d;
	}
	function q3(e) {
		let p = '',
			a = e;
		for (let d = 1; d <= 4; ++d) (p = String(a % 256) + p), d !== 4 && (p = '.' + p), (a = Math.floor(a / 256));
		return p;
	}
	function $3(e) {
		let p = [0, 0, 0, 0, 0, 0, 0, 0],
			...
			d = null,
			t = 0;
		if (((e = g1.ucs2.decode(e)), e[t] === 58)) {
			if (e[t + 1] !== 58) return E;
			(t += 2), ++a, (d = a);
		}
		for (; t < e.length; ) {
			if (a === 8) return E;
			...
			let i = 0,
				r = 0;
			for (; r < 4 && $(e[t]); ) (i = i * 16 + parseInt(aa(e, t), 16)), ++t, ++r;
			if (e[t] === 46) {
				if (r === 0 || ((t -= r), a > 6)) return E;
				let m = 0;
				for (; e[t] !== void 0; ) {
					let l = null;
					if (m > 0)
					...
					(p[a] = p[a] * 256 + l), ++m, (m === 2 || m === 4) && ++a;
				}
				if (m !== 4) return E;
				break;
			} else if (e[t] === 58) {
				if ((++t, e[t] === void 0)) return E;
			} else if (e[t] !== void 0) return E;
			(p[a] = i), ++a;
		}
		if (d !== null) {
			let i = a - d;
			for (a = 7; a !== 0 && i > 0; ) {
				let r = p[d + i - 1];
				(p[d + i - 1] = p[a]), (p[a] = r), --a, --i;
			}
		} else if (d === null && a !== 8) return E;
		return p;
	}
	function G3(e) {
		let p = '',
		...
		for (let i = 0; i <= 7; ++i)
			if (!(t && e[i] === 0)) {
				...
				(p += e[i].toString(16)), i !== 7 && (p += ':');
			}
		return p;
	}
	function rp(e, p) {
		if (e[0] === '[') return e[e.length - 1] !== ']' ? E : $3(e.substring(1, e.length - 1));
		if (!p) return H3(e);
		let a = M3(e),
			d = ea.toASCII(a, !1, ea.PROCESSING_OPTIONS.NONTRANSITIONAL, !1);
		if (d === null || b3(d)) return E;
		let t = k3(d);
		return typeof t == 'number' || t === E ? t : d;
	}
	function H3(e) {
		if (V3(e)) return E;
		let p = '',
			a = g1.ucs2.decode(e);
		for (let d = 0; d < a.length; ++d) p += h1(a[d], Te);
		return p;
	}
	function W3(e) {
		let p = null,
		...
		for (let i = 0; i < e.length; ++i)
			e[i] !== 0 ? (t > a && ((p = d), (a = t)), (d = null), (t = 0)) : (d === null && (d = i), ++t);
		return t > a && ((p = d), (a = t)), { idx: p, len: a };
	}
	function lp(e) {
		return typeof e == 'number' ? q3(e) : e instanceof Array ? '[' + G3(e) + ']' : e;
	}
	function j3(e) {
		return e.replace(/^[\u0000-\u001F\u0020]+|[\u0000-\u001F\u0020]+$/g, '');
	}
	...
	function la(e) {
		let p = e.path;
		p.length !== 0 && ((e.scheme === 'file' && p.length === 1 && K3(p[0])) || p.pop());
	}
	function sa(e) {
	...
	function R(e, p, a, d, t) {
		...
		for (
			i !== this.input && (this.parseError = !0),
				...
				this.input = g1.ucs2.decode(this.input);
			this.pointer <= this.input.length;
			++this.pointer
		) {
			let r = this.input[this.pointer],
				m = isNaN(r) ? void 0 : String.fromCodePoint(r),
				l = this['parse ' + this.state](r, m);
			if (l) {
				if (l === E) {
					this.failure = !0;
					break;
	...
	R.prototype['parse scheme start'] = function (p, a) {
		if ($1(p)) (this.buffer += a.toLowerCase()), (this.state = 'scheme');
		else if (!this.stateOverride) (this.state = 'no scheme'), --this.pointer;
		else return (this.parseError = !0), E;
		return !0;
	};
	R.prototype['parse scheme'] = function (p, a) {
		if (I3(p) || p === 43 || p === 45 || p === 46) this.buffer += a.toLowerCase();
		else if (p === 58) {
			if (
				(this.stateOverride &&
					((O(this.url) && !ip(this.buffer)) ||
						(!O(this.url) && ip(this.buffer)) ||
						((sa(this.url) || this.url.port !== null) && this.buffer === 'file') ||
			...
			this.url.scheme === 'file'
				? ((this.input[this.pointer + 1] !== 47 || this.input[this.pointer + 2] !== 47) &&
						(this.parseError = !0),
				  (this.state = 'file'))
				: O(this.url) && this.base !== null && this.base.scheme === this.url.scheme
	...
	R.prototype['parse no scheme'] = function (p) {
		return this.base === null || (this.base.cannotBeABaseURL && p !== 35)
			? E
			: (this.base.cannotBeABaseURL && p === 35
	...
	R.prototype['parse special relative or authority'] = function (p) {
		return (
			p === 47 && this.input[this.pointer + 1] === 47
				? ((this.state = 'special authority ignore slashes'), ++this.pointer)
				: ((this.parseError = !0), (this.state = 'relative'), --this.pointer),
			!0
		);
	};
	R.prototype['parse path or authority'] = function (p) {
		return p === 47 ? (this.state = 'authority') : ((this.state = 'path'), --this.pointer), !0;
	};
	R.prototype['parse relative'] = function (p) {
		return (
			(this.url.scheme = this.base.scheme),
			isNaN(p)
	...
	R.prototype['parse relative slash'] = function (p) {
		return (
			O(this.url) && (p === 47 || p === 92)
				? (p === 92 && (this.parseError = !0), (this.state = 'special authority ignore slashes'))
				: p === 47
	...
	R.prototype['parse special authority slashes'] = function (p) {
		return (
			p === 47 && this.input[this.pointer + 1] === 47
				? ((this.state = 'special authority ignore slashes'), ++this.pointer)
	...
	R.prototype['parse special authority ignore slashes'] = function (p) {
		return p !== 47 && p !== 92 ? ((this.state = 'authority'), --this.pointer) : (this.parseError = !0), !0;
	};
	R.prototype['parse authority'] = function (p, a) {
		if (p === 64) {
			(this.parseError = !0), this.atFlag && (this.buffer = '%40' + this.buffer), (this.atFlag = !0);
			let d = pa(this.buffer);
			for (let t = 0; t < d; ++t) {
				let i = this.buffer.codePointAt(t);
			...
			this.buffer = '';
		} else if (isNaN(p) || p === 47 || p === 63 || p === 35 || (O(this.url) && p === 92)) {
			if (this.atFlag && this.buffer === '') return (this.parseError = !0), E;
			(this.pointer -= pa(this.buffer) + 1), (this.buffer = ''), (this.state = 'host');
		} else this.buffer += a;
		return !0;
	};
	R.prototype['parse hostname'] = R.prototype['parse host'] = function (p, a) {
		if (this.stateOverride && this.url.scheme === 'file') --this.pointer, (this.state = 'file host');
		else if (p === 58 && !this.arrFlag) {
			if (this.buffer === '') return (this.parseError = !0), E;
			let d = rp(this.buffer, O(this.url));
			if (d === E) return E;
			if (((this.url.host = d), (this.buffer = ''), (this.state = 'port'), this.stateOverride === 'hostname'))
				return !1;
		} else if (isNaN(p) || p === 47 || p === 63 || p === 35 || (O(this.url) && p === 92)) {
			if ((--this.pointer, O(this.url) && this.buffer === '')) return (this.parseError = !0), E;
			if (this.stateOverride && this.buffer === '' && (sa(this.url) || this.url.port !== null))
				return (this.parseError = !0), !1;
			let d = rp(this.buffer, O(this.url));
			if (d === E) return E;
			if (((this.url.host = d), (this.buffer = ''), (this.state = 'path start'), this.stateOverride)) return !1;
		} else p === 91 ? (this.arrFlag = !0) : p === 93 && (this.arrFlag = !1), (this.buffer += a);
		return !0;
	};
	R.prototype['parse port'] = function (p, a) {
		if (q1(p)) this.buffer += a;
		else if (isNaN(p) || p === 47 || p === 63 || p === 35 || (O(this.url) && p === 92) || this.stateOverride) {
			if (this.buffer !== '') {
				let d = parseInt(this.buffer);
				if (d > Math.pow(2, 16) - 1) return (this.parseError = !0), E;
				(this.url.port = d === P3(this.url.scheme) ? null : d), (this.buffer = '');
			}
	...
	var z3 = new Set([47, 92, 63, 35]);
	R.prototype['parse file'] = function (p) {
		return (
			(this.url.scheme = 'file'),
			p === 47 || p === 92
				? (p === 92 && (this.parseError = !0), (this.state = 'file slash'))
				...
				? isNaN(p)
					...
					: (this.input.length - this.pointer - 1 === 0 ||
					  !y3(p, this.input[this.pointer + 1]) ||
					  (this.input.length - this.pointer - 1 >= 2 && !z3.has(this.input[this.pointer + 2]))
							? ((this.url.host = this.base.host), (this.url.path = this.base.path.slice()), la(this.url))
							: (this.parseError = !0),
					  (this.state = 'path'),
					  --this.pointer)
	...
	R.prototype['parse file slash'] = function (p) {
		return (
			p === 47 || p === 92
				? (p === 92 && (this.parseError = !0), (this.state = 'file host'))
				: (this.base !== null &&
						this.base.scheme === 'file' &&
						(L3(this.base.path[0])
	...
	R.prototype['parse file host'] = function (p, a) {
		if (isNaN(p) || p === 47 || p === 92 || p === 63 || p === 35)
			if ((--this.pointer, !this.stateOverride && ia(this.buffer))) (this.parseError = !0), (this.state = 'path');
			else if (this.buffer === '') {
				...
				let d = rp(this.buffer, O(this.url));
				if (d === E) return E;
				if ((d === 'localhost' && (d = ''), (this.url.host = d), this.stateOverride)) return !1;
				(this.buffer = ''), (this.state = 'path start');
			}
		else this.buffer += a;
		return !0;
	};
	R.prototype['parse path start'] = function (p) {
		return (
			O(this.url)
				? (p === 92 && (this.parseError = !0), (this.state = 'path'), p !== 47 && p !== 92 && --this.pointer)
				: !this.stateOverride && p === 63
				? ((this.url.query = ''), (this.state = 'query'))
				: !this.stateOverride && p === 35
				? ((this.url.fragment = ''), (this.state = 'fragment'))
				: p !== void 0 && ((this.state = 'path'), p !== 47 && --this.pointer),
			!0
		);
	};
	R.prototype['parse path'] = function (p) {
		if (isNaN(p) || p === 47 || (O(this.url) && p === 92) || (!this.stateOverride && (p === 63 || p === 35))) {
			if (
				(O(this.url) && p === 92 && (this.parseError = !0),
				C3(this.buffer)
					? (la(this.url), p !== 47 && !(O(this.url) && p === 92) && this.url.path.push(''))
					: da(this.buffer) && p !== 47 && !(O(this.url) && p === 92)
					? this.url.path.push('')
					: da(this.buffer) ||
					  (this.url.scheme === 'file' &&
				...
				(this.buffer = ''),
				this.url.scheme === 'file' && (p === void 0 || p === 63 || p === 35))
			)
				for (; this.url.path.length > 1 && this.url.path[0] === ''; )
					(this.parseError = !0), this.url.path.shift();
			p === 63 && ((this.url.query = ''), (this.state = 'query')),
				p === 35 && ((this.url.fragment = ''), (this.state = 'fragment'));
		} else
			p === 37 &&
	...
	R.prototype['parse cannot-be-a-base-URL path'] = function (p) {
		return (
			p === 63
				? ((this.url.query = ''), (this.state = 'query'))
				: p === 35
				? ((this.url.fragment = ''), (this.state = 'fragment'))
				: (!isNaN(p) && p !== 37 && (this.parseError = !0),
				  p === 37 &&
						(!$(this.input[this.pointer + 1]) || !$(this.input[this.pointer + 2])) &&
						(this.parseError = !0),
				  isNaN(p) || (this.url.path[0] = this.url.path[0] + h1(p, Te))),
			!0
		);
	};
	R.prototype['parse query'] = function (p, a) {
		if (isNaN(p) || (!this.stateOverride && p === 35)) {
			(!O(this.url) || this.url.scheme === 'ws' || this.url.scheme === 'wss') &&
				(this.encodingOverride = 'utf-8');
			let d = new Buffer(this.buffer);
			for (let t = 0; t < d.length; ++t)
				d[t] < 33 || d[t] > 126 || d[t] === 34 || d[t] === 35 || d[t] === 60 || d[t] === 62
					? (this.url.query += ra(d[t]))
					: (this.url.query += String.fromCodePoint(d[t]));
			(this.buffer = ''), p === 35 && ((this.url.fragment = ''), (this.state = 'fragment'));
		} else
			p === 37 &&
				(!$(this.input[this.pointer + 1]) || !$(this.input[this.pointer + 2])) &&
				(this.parseError = !0),
	...
	R.prototype['parse fragment'] = function (p) {
		return (
			isNaN(p) ||
				(p === 0
					? (this.parseError = !0)
		...
		if (
			(e.host !== null
				? ((a += '//'),
				  ...
				  (a += lp(e.host)),
				  e.port !== null && (a += ':' + e.port))
				: e.host === null && e.scheme === 'file' && (a += '//'),
			e.cannotBeABaseURL)
		)
			a += e.path[0];
		else for (let d of e.path) a += '/' + d;
		return e.query !== null && (a += '?' + e.query), !p && e.fragment !== null && (a += '#' + e.fragment), a;
	}
	function Q3(e) {
		let p = e.scheme + '://';
		return (p += lp(e.host)), e.port !== null && (p += ':' + e.port), p;
	}
	P.exports.serializeURL = J3;
	P.exports.serializeURLOrigin = function (e) {
		switch (e.scheme) {
			case 'blob':
				try {
					return P.exports.serializeURLOrigin(P.exports.parseURL(e.path[0]));
				} catch {
					return 'null';
				}
			case 'ftp':
			...
			case 'ws':
			case 'wss':
				return Q3({ scheme: e.scheme, host: e.host, port: e.port });
			case 'file':
				return 'file://';
			default:
				return 'null';
	...
	P.exports.basicURLParse = function (e, p) {
		p === void 0 && (p = {});
		let a = new R(e, p.baseURL, p.encodingOverride, p.url, p.stateOverride);
		return a.failure ? 'failure' : a.url;
	};
	P.exports.setTheUsername = function (e, p) {
		e.username = '';
		let a = g1.ucs2.decode(p);
		for (let d = 0; d < a.length; ++d) e.username += h1(a[d], mp);
	};
	P.exports.setThePassword = function (e, p) {
		e.password = '';
		let a = g1.ucs2.decode(p);
		for (let d = 0; d < a.length; ++d) e.password += h1(a[d], mp);
	};
	P.exports.serializeHost = lp;
	P.exports.cannotHaveAUsernamePasswordPort = X3;
	P.exports.serializeInteger = function (e) {
		return String(e);
	};
	P.exports.parseURL = function (e, p) {
		return (
			p === void 0 && (p = {}),
			P.exports.basicURLParse(e, { baseURL: p.baseURL, encodingOverride: p.encodingOverride })
		);
	};
});
var na = o(oa => {
	'use strict';
	var g = j();
	oa.implementation = class {
		constructor(p) {
			let a = p[0],
				d = p[1],
				t = null;
			if (d !== void 0 && ((t = g.basicURLParse(d)), t === 'failure')) throw new TypeError('Invalid base URL');
			let i = g.basicURLParse(a, { baseURL: t });
			if (i === 'failure') throw new TypeError('Invalid URL');
			this._url = i;
		}
		get href() {
			return g.serializeURL(this._url);
		}
		set href(p) {
			let a = g.basicURLParse(p);
			if (a === 'failure') throw new TypeError('Invalid URL');
			this._url = a;
		}
		get origin() {
			return g.serializeURLOrigin(this._url);
		}
		get protocol() {
			return this._url.scheme + ':';
		}
		set protocol(p) {
			g.basicURLParse(p + ':', { url: this._url, stateOverride: 'scheme start' });
		}
		get username() {
			return this._url.username;
		}
		set username(p) {
			g.cannotHaveAUsernamePasswordPort(this._url) || g.setTheUsername(this._url, p);
		}
		get password() {
			return this._url.password;
		}
		set password(p) {
			g.cannotHaveAUsernamePasswordPort(this._url) || g.setThePassword(this._url, p);
		}
		get host() {
			let p = this._url;
			return p.host === null
				? ''
				: p.port === null
				? g.serializeHost(p.host)
				: g.serializeHost(p.host) + ':' + g.serializeInteger(p.port);
		}
		set host(p) {
			this._url.cannotBeABaseURL || g.basicURLParse(p, { url: this._url, stateOverride: 'host' });
		}
		get hostname() {
			return this._url.host === null ? '' : g.serializeHost(this._url.host);
		}
		set hostname(p) {
			this._url.cannotBeABaseURL || g.basicURLParse(p, { url: this._url, stateOverride: 'hostname' });
		}
		get port() {
			return this._url.port === null ? '' : g.serializeInteger(this._url.port);
		}
		set port(p) {
			g.cannotHaveAUsernamePasswordPort(this._url) ||
				(p === '' ? (this._url.port = null) : g.basicURLParse(p, { url: this._url, stateOverride: 'port' }));
		}
		get pathname() {
		...
		set pathname(p) {
			this._url.cannotBeABaseURL ||
				((this._url.path = []), g.basicURLParse(p, { url: this._url, stateOverride: 'path start' }));
		}
		get search() {
		...
		set search(p) {
			...
			let d = p[0] === '?' ? p.substring(1) : p;
			(a.query = ''), g.basicURLParse(d, { url: a, stateOverride: 'query' });
		}
		get hash() {
		...
		set hash(p) {
			...
			let a = p[0] === '#' ? p.substring(1) : p;
			(this._url.fragment = ''), g.basicURLParse(a, { url: this._url, stateOverride: 'fragment' });
		}
		toJSON() {
			return this.href;
		}
...
var va = o((Io, G1) => {
	...
	var x = W2(),
		...
		N = ca.implSymbol;
	function _(e) {
		if (!this || this[N] || !(this instanceof _))
			throw new TypeError(
		...
		let p = [];
		for (let a = 0; a < arguments.length && a < 2; ++a) p[a] = arguments[a];
		(p[0] = x.USVString(p[0])), p[1] !== void 0 && (p[1] = x.USVString(p[1])), G1.exports.setup(this, p);
	}
	_.prototype.toJSON = function () {
		if (!this || !G1.exports.is(this)) throw new TypeError('Illegal invocation');
		let p = [];
		for (let a = 0; a < arguments.length && a < 0; ++a) p[a] = arguments[a];
		return this[N].toJSON.apply(this[N], p);
	};
	Object.defineProperty(_.prototype, 'href', {
		get() {
			return this[N].href;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].href = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	...
	Object.defineProperty(_.prototype, 'origin', {
		get() {
	...
	Object.defineProperty(_.prototype, 'protocol', {
		get() {
			return this[N].protocol;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].protocol = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'username', {
		...
		set(e) {
			(e = x.USVString(e)), (this[N].username = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'password', {
		...
		set(e) {
			(e = x.USVString(e)), (this[N].password = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'host', {
		get() {
			return this[N].host;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].host = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'hostname', {
		get() {
			return this[N].hostname;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].hostname = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'port', {
		get() {
			return this[N].port;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].port = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'pathname', {
		get() {
			return this[N].pathname;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].pathname = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'search', {
		get() {
			return this[N].search;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].search = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(_.prototype, 'hash', {
		get() {
			return this[N].hash;
		},
		set(e) {
			(e = x.USVString(e)), (this[N].hash = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	G1.exports = {
		is(e) {
			return !!e && e[N] instanceof ua.implementation;
		},
		create(e, p) {
			let a = Object.create(_.prototype);
			return this.setup(a, e, p), a;
		},
		setup(e, p, a) {
			a || (a = {}), (a.wrapper = e), (e[N] = new ua.implementation(p, a)), (e[N][ca.wrapperSymbol] = e);
		},
		interface: _,
		expose: { Window: { URL: _ }, Worker: { URL: _ } },
	};
});
var fa = o(Y => {
	'use strict';
	Y.URL = va().interface;
	Y.serializeURL = j().serializeURL;
	Y.serializeURLOrigin = j().serializeURLOrigin;
	Y.basicURLParse = j().basicURLParse;
	Y.setTheUsername = j().setTheUsername;
	Y.setThePassword = j().setThePassword;
	Y.serializeHost = j().serializeHost;
	Y.serializeInteger = j().serializeInteger;
	Y.parseURL = j().parseURL;
});
var _a = o((K, Oa) => {
	'use strict';
	...
	var G = _1(require('stream')),
		...
		c1 = class {
			...
			text() {
				return Promise.resolve(this[Z].toString());
			}
			arrayBuffer() {
				let p = this[Z],
					a = p.buffer.slice(p.byteOffset, p.byteOffset + p.byteLength);
				return Promise.resolve(a);
			}
			stream() {
				let p = new e5();
				return (p._read = function () {}), p.push(this[Z]), p.push(null), p;
			}
			toString() {
				return '[object Blob]';
			}
			slice() {
				let p = this.size,
					...
					t,
					i;
				a === void 0 ? (t = 0) : a < 0 ? (t = Math.max(p + a, 0)) : (t = Math.min(a, p)),
					d === void 0 ? (i = p) : d < 0 ? (i = Math.max(p + d, 0)) : (i = Math.min(d, p));
				let r = Math.max(i - t, 0),
					l = this[Z].slice(t, t + r),
					s = new c1([], { type: arguments[2] });
				return (s[Z] = l), s;
			}
		};
	...
	var up;
	try {
		up = require('encoding').convert;
	} catch {}
	var p1 = Symbol('Body internals'),
		Ea = G.PassThrough;
	function I(e) {
		var p = this,
		...
		e == null
			...
			(this[p1] = { body: e, disturbed: !1, error: null }),
			(this.size = t),
			(this.timeout = r),
			e instanceof G &&
				e.on('error', function (m) {
					let l =
						m.name === 'AbortError'
							? m
							: new C(`Invalid response body while trying to fetch ${p.url}: ${m.message}`, 'system', m);
					p[p1].error = l;
				});
	}
	I.prototype = {
		...
		get bodyUsed() {
			return this[p1].disturbed;
		},
		arrayBuffer() {
			return D1.call(this).then(function (e) {
				return e.buffer.slice(e.byteOffset, e.byteOffset + e.byteLength);
			});
		},
		blob() {
			let e = (this.headers && this.headers.get('content-type')) || '';
			return D1.call(this).then(function (p) {
				return Object.assign(new c1([], { type: e.toLowerCase() }), { [Z]: p });
			});
		},
		json() {
			var e = this;
			return D1.call(this).then(function (p) {
				try {
					...
					return I.Promise.reject(
						new C(`invalid json response body at ${e.url} reason: ${a.message}`, 'invalid-json'),
					);
				}
			});
		},
	...
	I.mixIn = function (e) {
		for (let p of Object.getOwnPropertyNames(I.prototype))
			if (!(p in e)) {
				let a = Object.getOwnPropertyDescriptor(I.prototype, p);
				Object.defineProperty(e, p, a);
			}
	};
	function D1() {
		var e = this;
		if (this[p1].disturbed) return I.Promise.reject(new TypeError(`body used already for: ${this.url}`));
		if (((this[p1].disturbed = !0), this[p1].error)) return I.Promise.reject(this[p1].error);
		let p = this.body;
		if (p === null) return I.Promise.resolve(Buffer.alloc(0));
		if ((j1(p) && (p = p.stream()), Buffer.isBuffer(p))) return I.Promise.resolve(p);
		if (!(p instanceof G)) return I.Promise.resolve(Buffer.alloc(0));
		let a = [],
			d = 0,
			t = !1;
		return new I.Promise(function (i, r) {
			...
			e.timeout &&
				...
				p.on('error', function (l) {
					l.name === 'AbortError'
						? ((t = !0), r(l))
						: r(new C(`Invalid response body while trying to fetch ${e.url}: ${l.message}`, 'system', l));
				}),
				p.on('data', function (l) {
					if (!(t || l === null)) {
						if (e.size && d + l.length > e.size) {
							(t = !0), r(new C(`content size at ${e.url} over limit: ${e.size}`, 'max-size'));
							return;
						}
						(d += l.length), a.push(l);
					}
				...
				p.on('end', function () {
					if (!t) {
						...
						try {
							...
							r(
								new C(
									`Could not create Buffer from response body for ${e.url}: ${l.message}`,
									'system',
									l,
								),
							);
	...
	function p5(e, p) {
		...
		let a = p.get('content-type'),
			d = 'utf-8',
			t,
			i;
		return (
			a && (t = /charset=([^;]*)/i.exec(a)),
			(i = e.slice(0, 1024).toString()),
			!t && i && (t = /<meta.+?charset=(['"])(.+?)\1/i.exec(i)),
			!t &&
				i &&
				((t = /<meta[\s]+?http-equiv=(['"])content-type\1[\s]+?content=(['"])(.+?)\2/i.exec(i)),
				t ||
					((t = /<meta[\s]+?content=(['"])(.+?)\1[\s]+?http-equiv=(['"])content-type\3/i.exec(i)),
					t && t.pop()),
				t && (t = /charset=(.*)/i.exec(t.pop()))),
			!t && i && (t = /<\?xml.+?encoding=(['"])(.+?)\1/i.exec(i)),
			t && ((d = t.pop()), (d === 'gb2312' || d === 'gbk') && (d = 'gb18030')),
			up(e, 'UTF-8', d).toString()
		);
	}
	function wa(e) {
	...
	function Aa(e) {
		...
		return (
			d instanceof G &&
				typeof d.getBoundary != 'function' &&
				((p = new Ea()), (a = new Ea()), d.pipe(p), d.pipe(a), (e[p1].body = p), (d = a)),
			d
		);
	}
	function Ra(e) {
	...
	function ga(e) {
		...
		return p === null
			...
			? p.length
			: p &&
			  typeof p.getLengthSync == 'function' &&
			  ((p._lengthRetrievers && p._lengthRetrievers.length == 0) || (p.hasKnownLength && p.hasKnownLength()))
			? p.getLengthSync()
			: null;
	}
	function a5(e, p) {
		let a = p.body;
		a === null ? e.end() : j1(a) ? a.stream().pipe(e) : Buffer.isBuffer(a) ? (e.write(a), e.end()) : a.pipe(e);
	}
	I.Promise = global.Promise;
	var Da = /[^\^_`a-zA-Z\-0-9!#$%&'*+.|~]/,
		cp = /[^\t\x20-\x7e\x80-\xff]/;
	function H1(e) {
		if (((e = `${e}`), Da.test(e) || e === '')) throw new TypeError(`${e} is not a legal HTTP header name`);
	}
	function Ta(e) {
		if (((e = `${e}`), cp.test(e))) throw new TypeError(`${e} is not a legal HTTP header value`);
	}
	function O1(e, p) {
		p = p.toLowerCase();
		for (let a in e) if (a.toLowerCase() === p) return a;
	}
	var D = Symbol('map'),
		b = class {
			constructor() {
				let p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : void 0;
				if (((this[D] = Object.create(null)), p instanceof b)) {
					let a = p.raw(),
						d = Object.keys(a);
					for (let t of d) for (let i of a[t]) this.append(t, i);
					return;
				}
				if (p != null)
					if (typeof p == 'object') {
						...
						if (a != null) {
							if (typeof a != 'function') throw new TypeError('Header pairs must be iterable');
							let d = [];
							for (let t of p) {
							...
							for (let t of d) {
								if (t.length !== 2) throw new TypeError('Each header pair must be a name/value tuple');
								this.append(t[0], t[1]);
							}
						} else
			...
			get(p) {
				(p = `${p}`), H1(p);
				let a = O1(this[D], p);
				return a === void 0 ? null : this[D][a].join(', ');
			}
			forEach(p) {
				...
				for (; t < d.length; ) {
					...
					let r = i[0],
						m = i[1];
					p.call(a, m, r, this), (d = vp(this)), t++;
				}
			}
			set(p, a) {
				(p = `${p}`), (a = `${a}`), H1(p), Ta(a);
				let d = O1(this[D], p);
				this[D][d !== void 0 ? d : p] = [a];
			}
			append(p, a) {
				(p = `${p}`), (a = `${a}`), H1(p), Ta(a);
				let d = O1(this[D], p);
				d !== void 0 ? this[D][d].push(a) : (this[D][p] = [a]);
			}
			has(p) {
				return (p = `${p}`), H1(p), O1(this[D], p) !== void 0;
			}
			delete(p) {
				(p = `${p}`), H1(p);
				let a = O1(this[D], p);
				a !== void 0 && delete this[D][a];
			}
			raw() {
				return this[D];
			}
			...
			[Symbol.iterator]() {
				return op(this, 'key+value');
			}
		};
	b.prototype.entries = b.prototype[Symbol.iterator];
	...
	function vp(e) {
		let p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'key+value';
		return Object.keys(e[D])
			.sort()
			.map(
				p === 'key'
					? function (d) {
					...
					: function (d) {
							return [d.toLowerCase(), e[D][d].join(', ')];
					  },
			);
	}
	var fp = Symbol('internal');
	function op(e, p) {
		let a = Object.create(Tp);
		return (a[fp] = { target: e, kind: p, index: 0 }), a;
	}
	var Tp = Object.setPrototypeOf(
		{
			next() {
				if (!this || Object.getPrototypeOf(this) !== Tp)
				...
				let p = e.target,
					...
					t = vp(p, a),
					i = t.length;
				return d >= i ? { value: void 0, done: !0 } : ((this[fp].index = d + 1), { value: t[d], done: !1 });
			},
		},
		Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]())),
	);
	Object.defineProperty(Tp, Symbol.toStringTag, {
	...
	function d5(e) {
		let p = Object.assign({ __proto__: null }, e[D]),
			a = O1(e[D], 'Host');
		return a !== void 0 && (p[a] = p[a][0]), p;
	}
	function t5(e) {
		let p = new b();
		for (let a of Object.keys(e))
			if (!Da.test(a))
				if (Array.isArray(e[a]))
					for (let d of e[a]) cp.test(d) || (p[D][a] === void 0 ? (p[D][a] = [d]) : p[D][a].push(d));
				else cp.test(e[a]) || (p[D][a] = [e[a]]);
		return p;
	}
	var n1 = Symbol('Response internals'),
		i5 = Na.STATUS_CODES,
		U = class {
			constructor() {
				let p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null,
					a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
				I.call(this, p, a);
				let d = a.status || 200,
					t = new b(a.headers);
				if (p != null && !t.has('Content-Type')) {
					let i = Ra(p);
					i && t.append('Content-Type', i);
				}
				this[n1] = { url: a.url, status: d, statusText: a.statusText || i5[d], headers: t, counter: a.counter };
			}
			get url() {
				return this[n1].url || '';
			}
			get status() {
				return this[n1].status;
			}
			get ok() {
				return this[n1].status >= 200 && this[n1].status < 300;
			}
			get redirected() {
				return this[n1].counter > 0;
			}
			get statusText() {
				return this[n1].statusText;
			}
			get headers() {
				return this[n1].headers;
			}
			clone() {
				return new U(Aa(this), {
					url: this.url,
					status: this.status,
	...
	var e1 = Symbol('Request internals'),
		r5 = Ne.URL || Sa.URL,
		m5 = Ne.parse,
		l5 = Ne.format;
	function np(e) {
		return /^[a-zA-Z][a-zA-Z\d+\-.]*:/.exec(e) && (e = new r5(e).toString()), m5(e);
	}
	var s5 = 'destroy' in G.Readable.prototype;
	function he(e) {
		return typeof e == 'object' && typeof e[e1] == 'object';
	}
	function o5(e) {
		let p = e && typeof e == 'object' && Object.getPrototypeOf(e);
	...
	var X = class {
		constructor(p) {
			let a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
				d;
			he(p) ? (d = np(p.url)) : (p && p.href ? (d = np(p.href)) : (d = np(`${p}`)), (p = {}));
			let t = a.method || p.method || 'GET';
			if (
				((t = t.toUpperCase()), (a.body != null || (he(p) && p.body !== null)) && (t === 'GET' || t === 'HEAD'))
			)
				throw new TypeError('Request with GET/HEAD method cannot have body');
			let i = a.body != null ? a.body : he(p) && p.body !== null ? Aa(p) : null;
			I.call(this, i, { timeout: a.timeout || p.timeout || 0, size: a.size || p.size || 0 });
			let r = new b(a.headers || p.headers || {});
			if (i != null && !r.has('Content-Type')) {
				let l = Ra(i);
				l && r.append('Content-Type', l);
			}
			let m = he(p) ? p.signal : null;
			if (('signal' in a && (m = a.signal), m != null && !o5(m)))
			...
			(this[e1] = {
				...
				(this.follow = a.follow !== void 0 ? a.follow : p.follow !== void 0 ? p.follow : 20),
				(this.compress = a.compress !== void 0 ? a.compress : p.compress !== void 0 ? p.compress : !0),
				(this.counter = a.counter || p.counter || 0),
				(this.agent = a.agent || p.agent);
		}
		get method() {
			return this[e1].method;
		}
		get url() {
			return l5(this[e1].parsedURL);
		}
		get headers() {
			return this[e1].headers;
		}
		get redirect() {
			return this[e1].redirect;
		}
		get signal() {
			return this[e1].signal;
		}
		clone() {
			return new X(this);
		}
	...
	function n5(e) {
		let p = e[e1].parsedURL,
			a = new b(e[e1].headers);
		if ((a.has('Accept') || a.set('Accept', '*/*'), !p.protocol || !p.hostname))
			throw new TypeError('Only absolute URLs are supported');
		if (!/^https?:$/.test(p.protocol)) throw new TypeError('Only HTTP(S) protocols are supported');
		if (e.signal && e.body instanceof G.Readable && !s5)
			throw new Error('Cancellation of streamed requests with AbortSignal is not supported in node < 8');
		let d = null;
		if ((e.body == null && /^(POST|PUT)$/i.test(e.method) && (d = '0'), e.body != null)) {
			let i = ga(e);
			typeof i == 'number' && (d = String(i));
		}
		d && a.set('Content-Length', d),
			a.has('User-Agent') || a.set('User-Agent', 'node-fetch/1.0 (+https://github.com/bitinn/node-fetch)'),
			e.compress && !a.has('Accept-Encoding') && a.set('Accept-Encoding', 'gzip,deflate');
		let t = e.agent;
		return (
			typeof t == 'function' && (t = t(p)),
			!a.has('Connection') && !t && a.set('Connection', 'close'),
			Object.assign({}, p, { method: e.method, headers: d5(a), agent: t })
		);
	}
	function W1(e) {
		Error.call(this, e),
	...
	W1.prototype = Object.create(Error.prototype);
	W1.prototype.constructor = W1;
	W1.prototype.name = 'AbortError';
	var Ep = Ne.URL || Sa.URL,
		ha = G.PassThrough,
		u5 = function (p, a) {
			let d = new Ep(a).hostname,
				t = new Ep(p).hostname;
			return d === t || (d[d.length - t.length - 1] === '.' && d.endsWith(t));
		};
	function u1(e, p) {
		if (!u1.Promise) throw new Error('native promise missing, set fetch.Promise to your favorite alternative');
		return (
			(I.Promise = u1.Promise),
			new u1.Promise(function (a, d) {
				let t = new X(e, p),
					i = n5(t),
					r = (i.protocol === 'https:' ? Z3 : Na).request,
					m = t.signal,
					l = null,
					s = function () {
						let h = new W1('The user aborted a request.');
						d(h),
							t.body && t.body instanceof G.Readable && t.body.destroy(h),
							!(!l || !l.body) && l.body.emit('error', h);
					};
				if (m && m.aborted) {
					s();
					return;
				...
				function v() {
					u.abort(), m && m.removeEventListener('abort', n), clearTimeout(c);
				}
				t.timeout &&
					u.once('socket', function (f) {
						c = setTimeout(function () {
							d(new C(`network timeout at: ${t.url}`, 'request-timeout')), v();
						}, t.timeout);
					}),
					u.on('error', function (f) {
						d(new C(`request to ${t.url} failed, reason: ${f.message}`, 'system', f)), v();
					}),
					u.on('response', function (f) {
						clearTimeout(c);
						let h = t5(f.headers);
						if (u1.isRedirect(f.statusCode)) {
							let r1 = h.get('Location'),
								Q = null;
							try {
								Q = r1 === null ? null : new Ep(r1, t.url).toString();
							} catch {
								if (t.redirect !== 'manual') {
									d(
										new C(
											`uri requested responds with an invalid redirect URL: ${r1}`,
											'invalid-redirect',
										),
									),
										v();
							...
							switch (t.redirect) {
								...
								case 'follow':
									...
									if (t.counter >= t.follow) {
										d(new C(`maximum redirect reached at: ${t.url}`, 'max-redirect')), v();
										return;
									}
									let E1 = {
									...
									if (!u5(t.url, Q))
										for (let T1 of ['authorization', 'www-authenticate', 'cookie', 'cookie2'])
											E1.headers.delete(T1);
									if (f.statusCode !== 303 && t.body && ga(t) === null) {
										d(
											new C(
									...
									(f.statusCode === 303 ||
										((f.statusCode === 301 || f.statusCode === 302) && t.method === 'POST')) &&
										((E1.method = 'GET'), (E1.body = void 0), E1.headers.delete('content-length')),
										a(u1(new X(Q, E1))),
										v();
									return;
							}
						...
						let F1 = { flush: N1.Z_SYNC_FLUSH, finishFlush: N1.Z_SYNC_FLUSH };
						if (B == 'gzip' || B == 'x-gzip') {
							(T = T.pipe(N1.createGunzip(F1))), (l = new U(T, L)), a(l);
							return;
						}
						if (B == 'deflate' || B == 'x-deflate') {
							f.pipe(new ha()).once('data', function (Q) {
								(Q[0] & 15) === 8
									? (T = T.pipe(N1.createInflate()))
									: (T = T.pipe(N1.createInflateRaw())),
									(l = new U(T, L)),
									a(l);
							});
							return;
						}
						if (B == 'br' && typeof N1.createBrotliDecompress == 'function') {
							(T = T.pipe(N1.createBrotliDecompress())), (l = new U(T, L)), a(l);
							return;
						}
						(l = new U(T, L)), a(l);
					}),
	...
	u1.isRedirect = function (e) {
		return e === 301 || e === 302 || e === 303 || e === 307 || e === 308;
	};
	u1.Promise = global.Promise;
	Oa.exports = K = u1;
	Object.defineProperty(K, '__esModule', { value: !0 });
	K.default = K;
	K.Headers = b;
...
var Se = o((yo, Ca) => {
	var Ia = {},
		c5 = e => {
			Ia.lodash = e.require('lodash');
		};
	Ca.exports = { setDependencies: c5, dependencies: Ia };
});
var La = o((Lo, ya) => {
	var v5 = (e, p) => `
import json
...
viewNames = spark.sql("show views in ${e}").rdd.map(lambda p: p.viewName).collect()
print(json.dumps(viewNames))
`;
	ya.exports = { getClusterData: v5, getViewNamesCommand: f5 };
});
var hp = o((bo, Pa) => {
	var { dependencies: E5 } = Se(),
		ba = e => {
			let p = E5.lodash.partition(e, S5);
			return { views: p[0].map(a => a.slice(0, -4)), tables: p[1] };
		},
		T5 = (e, p) => {
			let a = p.relative.value;
			return p.active === 'absolute' ? p.absolute.value : Math.round((e / 100) * a);
		},
		h5 = (e, p) =>
			e.reduce(
				(a, d) => {
					let { tables: t } = ba(p[d]),
						i = t.map(r => `"${r}"`).join(', ');
					return { tableNames: [...a.tableNames, `"${d}": [${i}]`], dbNames: e.map(r => `"${r}"`) };
				},
				{ viewNames: [], tableNames: [] },
			),
		N5 = (e, p) => {
			try {
				return Object.keys(e).reduce((a, d) => [...a, { customTagKey: d, customtagvalue: e[d] }], []);
			} catch {
				return p.log('error', e, 'Error converting custom tags'), [];
			}
		},
		S5 = e => e.slice(-4) === ' (v)',
		w5 = (e = '') => /^create (or replace |global |temporary ){0,1}view/.test(e.toLocaleLowerCase()),
		A5 = (e = '') => /^create (or replace ){0,1}table/.test(e.toLocaleLowerCase()),
		R5 = (e, p = '') => (Va(e) ? p.replace(/ \(v\)$/, '') : p),
		Va = (e = '') => parseInt(e.slice(0, e.indexOf('.'))) > 6,
		g5 = (e = {}) =>
			typeof e == 'string'
				? e
				: e.code === 'ENOTFOUND'
				? 'Cannot connect to workspace. Please check the Workspace URL or network connection.'
				: e.message || 'Reverse Engineering error',
		D5 = e => e.replace(/^\(|\)$/g, '');
	Pa.exports = {
		prepareNamesForInsertionIntoScalaCode: h5,
		splitTableAndViewNames: ba,
		convertCustomTags: N5,
		getErrorMessage: g5,
		getCount: T5,
		isViewDdl: w5,
		isTableDdl: A5,
		cleanEntityName: R5,
		isSupportGettingListOfViews: Va,
		removeParentheses: D5,
	};
});
var Sp = o((Vo, ka) => {
	'use strict';
	var Y1 = _a(),
		{ dependencies: v1 } = Se(),
		{ getClusterData: O5, getViewNamesCommand: _5 } = La(),
		{ getCount: I5, prepareNamesForInsertionIntoScalaCode: C5, removeParentheses: y5 } = hp(),
		H = {},
		L5 = () => {
			H.scala && Ma(H.scala.connectionInfo, H.scala.id), H.sql && Ma(H.sql.connectionInfo, H.sql.id), (H = {});
		},
		b5 = async (e, p) => {
			(d => {
				p.log('info', d, 'Applying to instance'), p.progress(d);
			})({
...
` + e.script,
						...
						}, e.applyToInstanceQueryRequestTimeout || 12e4),
					),
				]);
		},
		V5 = async ({ connectionInfo: e, dbName: p, tableName: a, fields: d, recordSamplingSettings: t }) => {
			try {
				let i = await z(e, `SELECT COUNT(*) FROM \`${p}\`.\`${a}\``, 'sql'),
					r = v1.lodash.get(i, '[0][0]', 0);
				if (r === 0) return [];
				let m = d.map(u => u.name),
					l = m.map(u => `\`${u}\``).join(', '),
					s = I5(r, t);
				return (await z(e, `SELECT ${l} FROM \`${p}\`.\`${a}\` LIMIT ${s}`, 'sql')).map(u =>
					m.reduce((c, v, f) => ({ ...c, [v]: u[f] }), {}),
				);
			} catch {
				return [];
			}
		...
		P5 = async e => {
			let p = e.host + `/api/2.0/clusters/get?cluster_id=${e.clusterId}`,
				a = Fa(e);
			return await Y1(p, a)
				.then(d => d.json())
				.then(d => {
					if (d.error_code) throw { message: d.message, code: d.error_code };
					return d;
				});
		},
		U5 = async e => {
			let p = await z(e, 'SHOW DATABASES', 'sql');
			return v1.lodash.flattenDeep(p);
		},
		M5 = (e, p) => z(p, `SHOW VIEWS IN \`${e}\``, 'sql'),
		B5 = (e, p) => z(p, _5(e), 'python'),
		F5 = (e, p) => z(p, `SHOW TABLES IN \`${e}\``, 'sql'),
		x5 = async (e, p, a, d) => {
			let i = (
					await Promise.all(
						a.map(async m => {
							d.log('info', '', `Start describe database: ${m} `);
							let l = await z(e, `DESCRIBE DATABASE EXTENDED \`${m}\``, 'sql');
							d.log('info', '', `Database: ${m} successfully described`);
							let s = l.reduce(
								(n, u) =>
									u[0] === 'Location'
										? { ...n, location: u[1] }
										...
										? { ...n, description: u[1] }
										: u[0] === 'Properties'
										? { ...n, dbProperties: W5(u[1]) }
										: n,
								{},
							);
							return { dbName: m, dbProperties: s };
						}),
					)
				).reduce((m, { dbName: l, dbProperties: s }) => ({ ...m, [l]: s }), {}),
				r = await Ba(a, p, e, d);
			return a.reduce(
				(m, l) => ({ ...m, [l]: { dbTables: v1.lodash.get(r, l, {}), dbProperties: v1.lodash.get(i, l, {}) } }),
				{},
			);
		},
		Ba = async (e, p, a, d, t = {}) => {
			let { tableNames: i, dbNames: r } = C5(e, p),
				m = O5(i.join(', '), r.join(', '));
			d.log(
				'info',
				'',
...
Tables: ${i.join(', ')}`,
			...
			let l = await z(a, m, 'python');
			d.log('info', '', `Finish retrieving tables info: ${l}`);
			let s = /\*\*\* WARNING: skipped \d* bytes of output \*\*\*$/.test(l);
			try {
				if (!s) {
					let L = JSON.parse(l);
					return Ua(t, L);
				...
				let n = '}, {',
					u = l.split(n),
					c = u.slice(0, u.length - 1).join(n),
					v = JSON.parse(c + '}]}'),
					f = Ua(t, v),
					{ dbNames: h, tableNames: T } = k5(p, f);
				return Ba(h, T, a, d, f);
			} catch (n) {
				throw (
					(d.log(
...
`,
		...
		k5 = (e, p) =>
			Object.keys(p).reduce(
				(a, d) => {
					let t = p[d].map(m => m.name),
						r = e[d].filter(m => !t.includes(m));
					return r.length ? { dbNames: [...a.dbNames, d], tableNames: { ...a.tableNames, [d]: r } } : a;
				},
				{ dbNames: [], tableNames: {} },
			),
		Ua = (e, p) =>
			v1.lodash.mergeWith(e, p, (a, d) => {
				if (Array.isArray(a) && Array.isArray(d)) return a.concat(d);
			}),
		q5 = async (e, p, a) => {
			try {
				let d = await z(p, `SHOW CREATE TABLE ${e};`, 'sql');
				return v1.lodash.get(d, '[0][0]', '');
			} catch (d) {
				return a.log('error', d, `Error during retrieve create table DDL statement. Table name: ${e}`), '';
			}
		},
		Fa = e => {
			let p = { Authorization: 'Bearer ' + e.accessToken };
			return { method: 'GET', headers: p };
		},
		Np = (e, p) => {
			let a = { 'Content-Type': 'application/json', Authorization: 'Bearer ' + e.accessToken };
			return { method: 'POST', headers: a, body: p };
		},
		$5 = (e, p) => {
			if (H[p]) return Promise.resolve(H[p].id);
			let a = e.host + '/api/1.2/contexts/create',
				d = JSON.stringify({ language: p, clusterId: e.clusterId }),
				t = Np(e, d);
			return Y1(a, t)
				.then(async i => {
...
${JSON.stringify(r)}`,
				...
				.then(i => ((i = JSON.parse(i)), (H[p] = { id: i.id, connectionInfo: e }), H[p].id));
		},
		Ma = (e, p) => {
			let a = e.host + '/api/1.2/contexts/destroy',
				d = JSON.stringify({ contextId: p, clusterId: e.clusterId }),
				t = Np(e, d);
			return Y1(a, t)
				.then(async i => {
					let r = await i.text();
					if (i.ok) return r;
					throw { message: i.statusText, code: i.status, description: d, responseBody: r };
				})
				.then(i => {
					i = JSON.parse(i);
				});
		...
		z = (e, p, a = 'sql') => {
			...
			return $5(e, a).then(t => {
				d = t;
				let i = e.host + '/api/1.2/commands/execute',
					r = JSON.stringify({ language: a, clusterId: e.clusterId, contextId: t, command: p }),
					m = Np(e, r);
				return Y1(i, m)
					.then(async l => {
						let s = await l.text();
						if (l.ok) return s;
						throw { message: l.statusText, code: l.status, description: r, responseBody: s };
					})
					.then(l => {
						l = JSON.parse(l);
						let s = new URL(e.host + '/api/1.2/commands/status'),
							n = { clusterId: e.clusterId, contextId: d, commandId: l.id };
						s.search = new URLSearchParams(n).toString();
						let u = Fa(e);
						return xa(s, u, r);
					});
			});
		...
		xa = (e, p, a) =>
			Y1(e, p)
				.then(async d => {
					let t = await d.text();
					if (d.ok) return t;
					throw { message: d.statusText, code: d.status, description: a, responseBody: t };
				})
				.then(d => {
					if (((d = JSON.parse(d)), d.status === 'Finished' && d.results !== null)) {
						if (d.results.resultType === 'error')
							throw { message: d.results.data || d.results.cause, code: '', description: a };
						return d.results.data;
					}
					if (d.status === 'Error')
						throw { message: 'Error during receiving command result', code: '', description: a };
					return xa(e, p, a);
				}),
		G5 = e => {
			let p = v1.lodash,
				a = i => !p.isNaN(p.toNumber(i)),
				d = i => p.toLower(i) === 'false' || p.toLower(i) === 'true',
				t = i => {
					switch (p.toLower(i)) {
						case 'true':
							return !0;
			...
			return a(e) ? p.toNumber(e) : d(e) ? t(e) : `'${e}'`;
		},
		H5 = e => {
			let p = v1.lodash,
				a = [],
		...
		W5 = (e = '') =>
			H5(y5(e)).map(p => {
				let a = p.indexOf(','),
					d = p.slice(0, a),
					t = p.slice(a + 1, p.length);
				return `'${d}'=${G5(t)}`;
			}).join(`,
`);
	ka.exports = {
		fetchClusterProperties: P5,
		fetchApplyToInstance: b5,
		fetchDocuments: V5,
		destroyActiveContext: L5,
		fetchClusterData: x5,
		fetchCreateStatementRequest: q5,
		fetchClusterDatabasesNames: U5,
		fetchDatabaseViewsNames: M5,
		fetchClusterTablesNames: F5,
		fetchDatabaseViewsNamesViaPython: B5,
	};
});
var Ga = o((Po, $a) => {
	'use strict';
	var { dependencies: wp } = Se(),
		a1 = Sp(),
		{ convertCustomTags: j5, cleanEntityName: Y5, isSupportGettingListOfViews: X5 } = hp(),
		K5 = (e, p, a, d) => a1.fetchCreateStatementRequest(`\`${p}\`.\`${a}\``, e, d),
		z5 = async (e, p, a) => {
			let d = wp.lodash,
				t = await a1.fetchClusterDatabasesNames(e);
			if ((a.log('info', t, 'Database list'), d.isEmpty(t))) return;
			let i = d.first(t),
				r = await a1.fetchClusterTablesNames(i, e);
			a.log('info', r, `Tables list in ${i} database`);
			let m = await qa(i, e, p, a);
			a.log('info', m, `Views list in ${i} database`);
		},
		J5 = async (e, p, a) => {
			try {
				let d = await a1.fetchDatabaseViewsNamesViaPython(e, p);
				return JSON.parse(d).map(i => [e, i]);
			} catch (d) {
				return a.log('warning', d, `Error getting view names from ${e} database via Python.`), [];
			}
		},
		Q5 = (e, p, a) => {
			try {
				return a1.fetchDatabaseViewsNames(e, p);
			} catch (d) {
				return (
					a.log(
						'warning',
						d,
						`Error getting view names from ${e} database via SQL. Run fallback via Python.`,
					),
					J5(e, p, a)
				);
			}
		...
		qa = async (e, p, a, d) => {
			let t = [],
				i = [];
			return X5(a)
				? ((i = (await Q5(e, p, d)).map(([m, l]) => l)),
				  (t = i.map(m => `${m} (v)`)),
				  { views: t, viewNames: i })
				: { views: t, viewNames: i };
		},
		Z5 = async (e, p, a) => {
			let d = await a1.fetchClusterDatabasesNames(e);
			return (
				a.log('info', d, 'Database names list'),
				await Promise.all(
					d.map(async t => {
						let { views: i, viewNames: r } = await qa(t, e, p, a),
							s = [
								...(await a1.fetchClusterTablesNames(t, e)).reduce(
									(n, [u, c]) => (r.includes(c) ? n : [...n, c]),
									[],
								),
								...i,
							];
						return { dbName: t, dbCollections: s, isEmpty: wp.lodash.isEmpty(s) };
					}),
				)
			);
		},
		e8 = async (e, p) => {
			let a = await a1.fetchClusterProperties(e);
			return {
				dbVersion: p8(a.spark_version),
				modelName: a.cluster_name,
				author: a.creator_user_name,
				host: e.host,
				port: a.jdbc_port,
				cluster_name: a.cluster_name,
				min_workers: a.num_workers,
				max_workers: a.num_workers,
				spark_version: a.spark_version,
				spark_conf: JSON.stringify(a.spark_conf),
				node_type_id: a.node_type_id,
				driver_node_type_id: a.driver_node_type_id,
				custom_tags: j5(a.custom_tags, p),
				autotermination_minutes: a.autotermination_minutes,
				enable_elastic_disk: a.enable_elastic_disk,
				aws_attributes: a.aws_attributes,
				isRunning: a.state === 'RUNNING',
				state: a.state,
			};
		},
		p8 = (e = '') => `Runtime ${e.split('.')[0]}`,
		a8 = (e, p, a, d, t) =>
			wp.lodash
				.flatMap(p, r => (a[r] || []).map(m => ({ dbName: r, name: m })))
				.map(async r => {
					let m = Y5(d, r.name),
						l = await K5(e, r.dbName, m, t);
					return { [`${r.dbName}.${m}`]: l };
				}),
		d8 = (e, p, a, d) => a1.fetchClusterData(e, a, p, d);
	$a.exports = {
		getFirstDatabaseCollectionName: z5,
		getDatabaseCollectionNames: Z5,
		getClusterStateInfo: e8,
		getClusterData: d8,
		getEntitiesDDL: a8,
	};
});
...
var ja = o((Mo, Wa) => {
	var d1 = require('os'),
		...
		m8 = (e, p, a = 5e3) =>
			new Promise((d, t) => {
				let i = setTimeout(() => {
						r.end(), t(new Error('Connection takes more than ' + 5e3 + ' ms'));
					}, a),
					r = i8.createConnection(p, e, () => {
						r.end(), clearTimeout(i), d();
					});
				r.on('error', m => {
					clearTimeout(i), t(m);
				});
		...
		l8 = () => r8.version,
		s8 = e => `Date: ${new Date()}
Application version: ${e.appVersion}
Plugin version: ${l8()}
...
System information:
 ...
 Platform:  ${d1.platform()} ${d1.arch()}
 Release:   ${d1.release()}
 Uptime:    ${u8(d1.uptime())}
 Total RAM: ${(d1.totalmem() / 1073741824).toFixed(2)} GB
 CPU Model: ${d1.cpus()[0].model}
 CPU Clock: ${o8(d1.cpus())} MHZ
 CPU Cores: ${d1.cpus().length} cores

`,
		o8 = e => e.reduce((p, a) => Math.max(p, a.speed), 0),
		n8 = e => (e < 10 ? '0' + e : e),
		u8 = e => Math.floor(e / 3600) + ':' + n8(parseInt((e / 3600 - Math.floor(e / 3600)) * 60)),
		c8 = { getSystemInfo: s8, checkConnection: m8 };
	Wa.exports = c8;
});
var K1 = o((Bo, Ja) => {
	var { dependencies: Ya } = q(),
		{ replaceSpaceWithUnderscore: we, getName: v8 } = W(),
		X1,
		Xa = ({ lodash: e }) => (X1 = e),
		Ka = e => e.keyspaceName,
		f8 = (e, p = [], a = 'new') =>
		...
		T8 = e => {
			Xa(Ya);
			let p = X1.get(e, 'role.properties', {});
			return { ...(X1.get(e, 'properties', {}) || {}), ...p };
		},
		h8 = (e = {}, p = 'collectionName') => ({
			oldName: we(e.code?.old || e[p]?.old),
			newName: we(e.code?.new || e[p]?.new),
		}),
		N8 = (...e) => e.filter(Boolean);
	Ja.exports = {
		getEntityData: f8,
		getFullEntityName: za,
		generateFullEntityName: E8,
		getEntityProperties: T8,
		getContainerName: Ka,
		getEntityName: h8,
		prepareScript: N8,
	};
...
var Ae = o((Fo, pd) => {
	var { dependencies: Qa } = q(),
		f1,
		Za = ({ lodash: e }) => (f1 = e),
		ed = (e = [], p = []) => {
			Za(Qa);
			let a = f1.intersectionWith(e, p, f1.isEqual);
			return { add: f1.xorWith(e, a, f1.isEqual), drop: f1.xorWith(p, a, f1.isEqual) };
		},
		S8 = ({ new: e, old: p }, a) => {
			let d = u => (u || '').split(',').map(c => c.trim()),
				t = u =>
					u.join(`,
`),
				i = u => u.map(c => c.replace(/(=\S+)/, '')).join(', '),
				r = d(e),
				m = d(p),
				{ add: l, drop: s } = ed(r, m);
			return { dataProperties: { add: t(l), drop: i(s) }, name: a };
		},
		w8 = ({ new: e, old: p }) => {
			if ((Za(Qa), !(!e && !p))) return !f1.isEqual(e, p);
		},
		A8 = (e, p) => p.some(a => w8(e[a] || {}));
	pd.exports = { hydrateTableProperties: S8, getDifferentItems: ed, getIsChangeProperties: A8 };
});
var rd = o((xo, id) => {
	var { getDatabaseStatement: R8, getDatabaseAlterStatement: g8 } = We(),
		{ dependencies: D8 } = q(),
		{ getEntityData: O8 } = K1(),
		{ getIsChangeProperties: _8 } = Ae(),
		ad,
		I8 = ['comment', 'location', 'dbProperties'],
		C8 = ['name', 'location'],
		y8 = ({ lodash: e }) => (ad = e),
		L8 = e => O8(e, I8),
		dd = e => {
		...
		b8 = e => p => {
			let a = dd(p);
			return e.dropDatabase(a);
		},
		V8 = e => p => {
			y8(D8);
			let a = ad.get(p, 'role.compMod', {}),
				d = n => a.code?.[n] || a.name?.[n],
				t = { new: d('new'), old: d('old') },
				i = _8({ ...a, name: t }, C8),
				r = { ...L8(a), name: t.new };
			if (!i) return g8([r]);
			let m = dd({ role: { ...r, name: t.old } }),
				l = e.dropDatabase(m),
				s = td({ role: r });
			return [l, s];
		};
	id.exports = { getAddContainerScript: td, getDeleteContainerScript: b8, getModifyContainerScript: V8 };
});
var ud = o((ko, nd) => {
	var { dependencies: I1 } = q(),
		{ getColumns: P8, getColumnsStatement: U8 } = Ke(),
		{ getIndexes: z1 } = dp(),
		{ getTableStatement: Ap } = Qe(),
		{ hydrateTableProperties: M8, getDifferentItems: B8, getIsChangeProperties: F8 } = Ae(),
		{
			getFullEntityName: md,
			generateFullEntityName: C1,
			getEntityProperties: ge,
			getContainerName: Re,
			getEntityData: x8,
			getEntityName: k8,
			prepareScript: J,
		...
		$8 = (e, p) => {
			let { serDeProperties: a, serDeLibrary: d } = e;
			return {
				properties: !S.isEqual(a?.new, a?.old) && a?.new,
				serDe: !S.isEqual(d?.new, d?.old) && d?.new,
				name: p,
			};
		},
		G8 = e => {
			let { newName: p, oldName: a } = k8(e);
			return (!p && !a) || p === a ? {} : { oldName: md(Re(e), a), newName: md(Re(e), p) };
		},
		H8 = (e, p = {}) => {
			let a = C1(e),
				d = Object.values(p).map(t => {
					let i = S.get(t, 'compMod', {}),
						{ newField: r = {}, oldField: m = {} } = i;
					return r.name && m.name && r.name !== m.name ? { oldName: m.name, newName: r.name } : '';
				});
			return { collectionName: a, columns: d.filter(Boolean) };
		},
		sd = e => (S.get(e, 'BloomIndxs', []).length ? C1(e) : ''),
		od = (e, p, a, d) => {
			let t = S.get(e, 'role.compMod', {}),
				i = S.get(e, 'role', {});
			return [[{ name: Re(t) }], [i, { BloomIndxs: p }], { ...i, properties: a }, d];
		},
		De = (e, p, a) => {
			let d = S.get(e, 'role.compMod.BloomIndxs', {}),
				{ drop: t, add: i } = B8(d.new, d.old);
			return { hydratedDropIndex: sd({ ...e, BloomIndxs: t }), hydratedAddIndex: od(e, i, p, a) };
		},
		Rp = (e, p) => {
			let a = S.get(e, 'role.compMod', {}),
				d = S.get(e, 'role', {}),
				t = ge(e);
			return [[{ name: Re(a) }], [d], { ...d, properties: t }, p];
		},
		gp = (e, p, a) => {
			let d = S.get(e, 'role.compMod', {}),
				t = F8(d, ld),
				i = C1(e);
			if (t) {
				let c = x8(d, ld.concat(q8)),
					v = Rp({ ...e, role: { ...e.role, ...c } }, p),
					f = Ap(...v, !0),
					h = a.dropTable(i);
				return { type: 'new', script: J(h, f) };
			}
			let r = S.get(d, 'tableProperties', ''),
				m = a.alterTableName(G8(d)),
				l = M8(r, i),
				s = $8(d, i),
				n = a.alterTableProperties(l),
				u = a.alterSerDeProperties(s);
			return { type: 'modify', script: J(m, ...n, u) };
		},
		W8 = e => p => {
			y1(I1);
			let a = ge(p),
				d = S.get(p, 'role.BloomIndxs', []),
				t = Rp(p, e),
				i = Ap(...t, !0),
				r = z1(...od(p, d, a, e));
			return J(i, r);
		...
		j8 = e => p => {
			y1(I1);
			let a = { ...p, ...S.get(p, 'role', {}) },
				d = C1(p),
				t = e.dropTable(d),
				i = e.dropTableIndex(sd(a));
			return J(i, t);
		},
		Y8 = (e, p) => a => {
			y1(I1);
			let d = ge(a),
				{ script: t } = gp(a, e, p),
				{ hydratedAddIndex: i, hydratedDropIndex: r } = De(a, d, e),
				m = p.dropTableIndex(r),
				l = z1(...i);
			return J(m, ...t, l);
		},
		X8 = (e, p) => a => {
			y1(I1);
			let d = { ...a, ...S.omit(a.role, ['properties']) },
				{ columns: t } = P8(d, !0, e),
				i = ge(a),
				r = U8(t),
				m = C1(a),
				{ hydratedAddIndex: l, hydratedDropIndex: s } = De(a, i, e),
				n = gp(a, e, p),
				u = p.dropTableIndex(s),
				c = z1(...l),
				v = p.addTableColumns({ name: m, columns: r });
			return n.type === 'new' ? J(u, ...n.script, c) : J(u, v, ...n.script, c);
		},
		K8 = (e, p) => a => {
			y1(I1);
			let d = Object.keys(a.properties || {}),
				t = S.omit(S.get(a, 'role.properties', {}), d),
				i = { role: { ...S.omit(a.role, ['properties']), properties: t } },
				{ hydratedAddIndex: r, hydratedDropIndex: m } = De(a, t, e),
				l = C1(a),
				s = p.dropTableIndex(m),
				n = z1(...r),
				u = p.dropTable(l),
				c = Rp(i, e),
				v = Ap(...c, !0);
		...
		z8 = (e, p) => a => {
			y1(I1);
			let d = S.get(a, 'properties', {}),
				t = S.unionWith(Object.entries(d), Object.entries(S.get(a, 'role.properties', {})), (v, f) =>
					S.isEqual(S.get(v, '[1].GUID'), S.get(f, '[1].GUID')),
				),
				i = { role: { ...S.omit(a.role || {}, ['properties']), properties: Object.fromEntries(t) } },
				r = H8(a, d),
				m = p.alterTableColumnName(r),
				l = gp(i, e, p),
				{ hydratedAddIndex: s, hydratedDropIndex: n } = De(a, d, e),
				u = p.dropTableIndex(n),
				c = z1(...s);
			return l.type === 'new' ? J(u, ...l.script, c) : J(u, ...m, ...l.script, c);
		};
	nd.exports = {
		getAddCollectionsScripts: W8,
		getDeleteCollectionsScripts: j8,
		getModifyCollectionsScripts: Y8,
		getAddColumnsScripts: X8,
		getDeleteColumnsScripts: K8,
		getModifyColumnsScripts: z8,
	};
});
var Ad = o((qo, wd) => {
	var { dependencies: vd } = q(),
		{ getViewScript: fd } = tp(),
		{ hydrateTableProperties: J8 } = Ae(),
		{
			getEntityData: Q8,
			getEntityProperties: Z8,
			getContainerName: Ed,
			generateFullEntityName: Td,
			getEntityName: et,
			prepareScript: cd,
			getFullEntityName: pt,
		} = K1(),
		t1,
		hd = ({ lodash: e }) => (t1 = e),
		Nd = ['code', 'name', 'tableProperties', 'selectStatement'],
		at = ['viewTemporary', 'viewOrReplace', 'isGlobal', 'description'],
		dt = (e, p) => {
			let a = t1.get(e, 'role.compMod', {});
			return p.some(d => {
				let { new: t, old: i } = a[d] || {};
				return (!!t || !!i) && !t1.isEqual(t, i);
			});
		},
		tt = e => Object.entries(e).reduce((p, [a, d = {}]) => ({ ...p, [a]: { ...d, GUID: d.refId || '' } }), {}),
		it = e => Object.entries(e).reduce((p, [a, d = {}]) => ({ ...p, [a]: { ...d, definitionId: a } }), {}),
		Sd = e => {
			let p = t1.get(e, 'role.compMod', {}),
				a = tt(Z8(e)),
				d = Q8(p, Nd.concat(at)),
				t = { ...t1.get(e, 'role', {}), ...d, properties: a },
				i = it(t.compMod?.collectionData?.collectionRefsDefinitionsMap || {});
			return { schema: t, collectionRefsDefinitionsMap: i, viewData: [t], containerData: [{ name: Ed(p) }] };
		},
		rt = e => {
			let p = t1.get(e, 'role.compMod', {}),
				a = et(p, 'name'),
				d = Ed(p),
				t = pt(d, a.newName),
				i = t1.get(p, 'tableProperties', ''),
				{ new: r, old: m } = t1.get(p, 'selectStatement', ''),
				{ dataProperties: l } = J8(i, t);
			return {
				selectStatement: !t1.isEqual(r, m) && r ? r : '',
				dataProperties: l,
				fullName: t,
				dbName: d,
				rename: a,
	...
	wd.exports = { getAddViewsScripts: mt, getDeleteViewsScripts: lt, getModifyViewsScripts: st };
});
var Dp = o(($o, Rd) => {
	Rd.exports = { DROP_STATEMENTS: ['DROP BLOOMFILTER', 'DROP VIEW', 'DROP TABLE', 'DROP DATABASE'] };
});
var Dd = o((Go, gd) => {
	function ot(e, p, a, d) {
		for (var t = e.length, i = a + (d ? 1 : -1); d ? i-- : ++i < t; ) if (p(e[i], i, e)) return i;
		return -1;
	}
	gd.exports = ot;
});
...
var Cd = o((Wo, Id) => {
	function ut(e, p, a) {
		for (var d = a - 1, t = e.length; ++d < t; ) if (e[d] === p) return d;
		return -1;
	}
	Id.exports = ut;
});
...
var Bd = o((zo, Md) => {
	var Pd = Oe(),
		Ud = Object.prototype,
		Rt = Ud.hasOwnProperty,
		gt = Ud.toString,
		J1 = Pd ? Pd.toStringTag : void 0;
	function Dt(e) {
		var p = Rt.call(e, J1),
			a = e[J1];
		try {
		...
		var t = gt.call(e);
		return d && (p ? (e[J1] = a) : delete e[J1]), t;
	}
	Md.exports = Dt;
});
var xd = o((Jo, Fd) => {
...
var S1 = o((Qo, $d) => {
	var kd = Oe(),
		...
		Lt = '[object Null]',
		bt = '[object Undefined]',
		qd = kd ? kd.toStringTag : void 0;
	function Vt(e) {
		return e == null ? (e === void 0 ? bt : Lt) : qd && qd in Object(e) ? Ct(e) : yt(e);
	}
	$d.exports = Vt;
});
var Q1 = o((Zo, Gd) => {
...
var Z1 = o((an, jd) => {
	var Ht = Ip(),
		Wt = Cp();
	function jt(e) {
		return e != null && Wt(e.length) && !Ht(e);
	}
	jd.exports = jt;
});
var ee = o((dn, Yd) => {
...
var zd = o((rn, Kd) => {
	var Kt = S1(),
		...
		Qt = '[object String]';
	function Zt(e) {
		return typeof e == 'string' || (!zt(e) && Jt(e) && Kt(e) == Qt);
	}
	Kd.exports = Zt;
});
var yp = o((mn, Jd) => {
	var e7 = /\s/;
	function p7(e) {
		for (var p = e.length; p-- && e7.test(e.charAt(p)); );
		return p;
	}
	Jd.exports = p7;
});
var Zd = o((ln, Qd) => {
	var a7 = yp(),
		d7 = /^\s+/;
	function t7(e) {
		return e && e.slice(0, a7(e) + 1).replace(d7, '');
	}
	Qd.exports = t7;
});
var Lp = o((sn, e6) => {
	var i7 = S1(),
		...
		m7 = '[object Symbol]';
	function l7(e) {
		return typeof e == 'symbol' || (r7(e) && i7(e) == m7);
	}
	e6.exports = l7;
});
var t6 = o((on, d6) => {
	...
	function f7(e) {
		...
		if (o7(e)) return a6;
		if (p6(e)) {
			var p = typeof e.valueOf == 'function' ? e.valueOf() : e;
			e = p6(p) ? p + '' : p;
		}
		if (typeof e != 'string') return e === 0 ? e : +e;
		e = s7(e);
		var a = u7.test(e);
		return a || c7.test(e) ? v7(e.slice(2), a ? 2 : 8) : n7.test(e) ? a6 : +e;
	}
	d6.exports = f7;
});
var m6 = o((nn, r6) => {
...
var Vp = o((cn, s6) => {
	function w7(e, p) {
		for (var a = -1, d = e == null ? 0 : e.length, t = Array(d); ++a < d; ) t[a] = p(e[a], a, e);
		return t;
	}
	s6.exports = w7;
});
...
var c6 = o((fn, u6) => {
	function g7(e, p) {
		for (var a = -1, d = Array(e); ++a < e; ) d[a] = p(a);
		return d;
	}
	u6.exports = g7;
});
...
var Pp = o((Tn, h6) => {
	var E6 = f6(),
		C7 = L1(),
		T6 = Object.prototype,
		y7 = T6.hasOwnProperty,
		L7 = T6.propertyIsEnumerable,
		b7 = E6(
			(function () {
				return arguments;
			})(),
			...
			? E6
			: function (e) {
					return C7(e) && y7.call(e, 'callee') && !L7.call(e, 'callee');
			  };
	h6.exports = b7;
});
var S6 = o((hn, N6) => {
...
var Up = o((pe, b1) => {
	var P7 = i1(),
		U7 = S6(),
		R6 = typeof pe == 'object' && pe && !pe.nodeType && pe,
		w6 = R6 && typeof b1 == 'object' && b1 && !b1.nodeType && b1,
		M7 = w6 && w6.exports === R6,
		A6 = M7 ? P7.Buffer : void 0,
		B7 = A6 ? A6.isBuffer : void 0,
		F7 = B7 || U7;
	b1.exports = F7;
});
var Mp = o((Nn, g6) => {
	var x7 = 9007199254740991,
		k7 = /^(?:0|[1-9]\d*)$/;
	function q7(e, p) {
		var a = typeof e;
		return (p = p ?? x7), !!p && (a == 'number' || (a != 'symbol' && k7.test(e))) && e > -1 && e % 1 == 0 && e < p;
	}
	g6.exports = q7;
});
var O6 = o((Sn, D6) => {
	var $7 = S1(),
		...
		vi = '[object Uint32Array]',
		w = {};
	w[ri] = w[mi] = w[li] = w[si] = w[oi] = w[ni] = w[ui] = w[ci] = w[vi] = !0;
	w[W7] =
		w[j7] =
		w[ti] =
		w[Y7] =
...
var y6 = o((ae, V1) => {
	var Ti = _p(),
		C6 = typeof ae == 'object' && ae && !ae.nodeType && ae,
		de = C6 && typeof V1 == 'object' && V1 && !V1.nodeType && V1,
		hi = de && de.exports === C6,
		Bp = hi && Ti.process,
		Ni = (function () {
			try {
				var e = de && de.require && de.require('util').types;
				return e || (Bp && Bp.binding && Bp.binding('util'));
			} catch {}
		})();
	V1.exports = Ni;
});
...
var xp = o((gn, M6) => {
	...
	function Vi(e) {
		var p = e && e.constructor,
			a = (typeof p == 'function' && p.prototype) || bi;
		return e === a;
	}
	M6.exports = Vi;
});
...
var kp = o((_n, q6) => {
	...
	function qi(e) {
		if (!Bi(e)) return Fi(e);
		var p = [];
		for (var a in Object(e)) ki.call(e, a) && a != 'constructor' && p.push(a);
		return p;
	}
	q6.exports = qi;
});
...
var Y6 = o((yn, j6) => {
	var Ki = Op(),
		...
		er = Math.max;
	function pr(e, p, a, d) {
		(e = zi(e) ? e : Zi(e)), (a = a && !d ? Qi(a) : 0);
		var t = e.length;
		return a < 0 && (a = er(t + a, 0)), Ji(e) ? a <= t && e.indexOf(p, a) > -1 : !!t && Ki(e, p, a) > -1;
	}
	j6.exports = pr;
});
var qp = o((Ln, Q6) => {
	var X6 = Oe(),
		...
		tr = Lp(),
		ir = 1 / 0,
		K6 = X6 ? X6.prototype : void 0,
		z6 = K6 ? K6.toString : void 0;
	function J6(e) {
		if (typeof e == 'string') return e;
		if (dr(e)) return ar(e, J6) + '';
		if (tr(e)) return z6 ? z6.call(e) : '';
		var p = e + '';
		return p == '0' && 1 / e == -ir ? '-0' : p;
	}
	Q6.exports = J6;
});
var e4 = o((bn, Z6) => {
	function rr(e, p, a) {
		...
		p < 0 && (p = -p > t ? 0 : t + p),
			...
			(t = p > a ? 0 : (a - p) >>> 0),
			(p >>>= 0);
		for (var i = Array(t); ++d < t; ) i[d] = e[d + p];
		return i;
	}
	Z6.exports = rr;
});
var a4 = o((Vn, p4) => {
	...
	function lr(e, p, a) {
		var d = e.length;
		return (a = a === void 0 ? d : a), !p && a >= d ? e : mr(e, p, a);
	}
	p4.exports = lr;
});
var t4 = o((Pn, d4) => {
	var sr = Op();
	function or(e, p) {
		for (var a = e.length; a-- && sr(p, e[a], 0) > -1; );
		return a;
	}
	d4.exports = or;
});
...
var E4 = o((Bn, f4) => {
	var s4 = '\\ud800-\\udfff',
		...
		c4 = _r + '?',
		v4 = '[' + Dr + ']?',
		Cr = '(?:' + Ir + '(?:' + [o4, n4, u4].join('|') + ')' + v4 + c4 + ')*',
		yr = v4 + c4 + Cr,
		Lr = '(?:' + [o4 + $p + '?', $p, n4, u4, Or].join('|') + ')',
		br = RegExp(Gp + '(?=' + Gp + ')|' + Lr + yr, 'g');
	function Vr(e) {
		return e.match(br) || [];
	}
	f4.exports = Vr;
...
var A4 = o((kn, w4) => {
	var kr = qp(),
		...
		Hr = yp();
	function Wr(e, p, a) {
		if (((e = Gr(e)), e && (a || p === void 0))) return e.slice(0, Hr(e) + 1);
		if (!e || !(p = kr(p))) return e;
		var d = S4(e),
			t = $r(d, S4(p)) + 1;
		return qr(d, 0, t).join('');
	}
	w4.exports = Wr;
});
var Ce = o((Ie, R4) => {
...
var D4 = o((qn, g4) => {
	...
	function Xr(e, p) {
		var a = '';
		if (!e || p < 1 || p > jr) return a;
		do p % 2 && (a += e), (p = Yr(p / 2)), p && (e += e);
		while (p);
		return a;
	}
	g4.exports = Xr;
...
var C4 = o((Gn, I4) => {
	...
	function em(e, p, a) {
		if (!Zr(a)) return !1;
		var d = typeof p;
		return (d == 'number' ? Jr(a) && Qr(p, a.length) : d == 'string' && p in a) ? zr(a[p], e) : !1;
	}
	I4.exports = em;
});
var L4 = o((Hn, y4) => {
	var pm = D4(),
		...
		tm = _e();
	function im(e, p, a) {
		return (a ? am(e, p, a) : p === void 0) ? (p = 1) : (p = dm(p)), pm(tm(e), p);
	}
	y4.exports = im;
});
var V4 = o((Wn, b4) => {
...
var M4 = o((ye, U4) => {
	...
	var Hp = 'top-level',
		...
		cm = (function () {
			function e(p) {
				nm(this, e), (this.indent = p || '  '), (this.indentTypes = []);
			}
			return (
				(e.prototype.getIndent = function () {
					return (0, lm.default)(this.indent, this.indentTypes.length);
				}),
				(e.prototype.increaseToplevel = function () {
					this.indentTypes.push(Hp);
				}),
				(e.prototype.increaseBlockLevel = function () {
					this.indentTypes.push(um);
				}),
				(e.prototype.decreaseTopLevel = function () {
					(0, om.default)(this.indentTypes) === Hp && this.indentTypes.pop();
				}),
				(e.prototype.decreaseBlockLevel = function () {
					for (; this.indentTypes.length > 0; ) {
						var a = this.indentTypes.pop();
						if (a !== Hp) break;
					}
				}),
				e
...
var F4 = o((Le, B4) => {
	...
	var Tm = 50,
		hm = (function () {
			function e() {
				Em(this, e), (this.level = 0);
			}
			return (
				(e.prototype.beginIfPossible = function (a, d) {
					this.level === 0 && this.isInlineBlock(a, d)
						? (this.level = 1)
						: this.level > 0
						? this.level++
						: (this.level = 0);
				...
				(e.prototype.isInlineBlock = function (a, d) {
					for (var t = 0, i = 0, r = d; r < a.length; r++) {
						var m = a[r];
						if (((t += m.value.length), t > Tm)) return !1;
						if (m.type === P1.default.OPEN_PAREN) i++;
						else if (m.type === P1.default.CLOSE_PAREN && (i--, i === 0)) return !0;
						if (this.isForbiddenToken(m)) return !1;
					}
					return !1;
				}),
				(e.prototype.isForbiddenToken = function (a) {
					var d = a.type,
						t = a.value;
					return (
						d === P1.default.RESERVED_TOPLEVEL ||
						d === P1.default.RESERVED_NEWLINE ||
						d === P1.default.COMMENT ||
						d === P1.default.BLOCK_COMMENT ||
						t === ';'
					);
				}),
				e
...
var k4 = o((be, x4) => {
	...
	var Sm = (function () {
		function e(p) {
			Nm(this, e), (this.params = p), (this.index = 0);
		}
		return (
			(e.prototype.get = function (a) {
				var d = a.key,
					t = a.value;
				return this.params ? (d ? this.params[d] : this.params[this.index++]) : t;
			}),
			e
		);
	})();
	be.default = Sm;
	x4.exports = be.default;
});
var te = o((Pe, q4) => {
	'use strict';
	Pe.__esModule = !0;
	...
	var bm = (function () {
		function e(p, a) {
			Lm(this, e),
				(this.cfg = p || {}),
				(this.indentation = new Om.default(this.cfg.indent)),
				(this.inlineBlock = new Im.default()),
				(this.params = new ym.default(this.cfg.params)),
				(this.tokenizer = a),
		...
		return (
			(e.prototype.format = function (a) {
				this.tokens = this.tokenizer.tokenize(a);
				var d = this.getFormattedQueryFromTokens();
				return d.trim();
			}),
			(e.prototype.getFormattedQueryFromTokens = function () {
				...
				return (
					this.tokens.forEach(function (t, i) {
						(a.index = i),
							t.type === V.default.WHITESPACE ||
								(t.type === V.default.LINE_COMMENT
									? (d = a.formatLineComment(t, d))
									: t.type === V.default.BLOCK_COMMENT
									? (d = a.formatBlockComment(t, d))
									: t.type === V.default.RESERVED_TOPLEVEL
									? ((d = a.formatToplevelReservedWord(t, d)), (a.previousReservedWord = t))
									: t.type === V.default.RESERVED_NEWLINE
									? ((d = a.formatNewlineReservedWord(t, d)), (a.previousReservedWord = t))
									: t.type === V.default.RESERVED
									? ((d = a.formatWithSpaces(t, d)), (a.previousReservedWord = t))
									: t.type === V.default.OPEN_PAREN
									? (d = a.formatOpeningParentheses(t, d))
									: t.type === V.default.CLOSE_PAREN
									? (d = a.formatClosingParentheses(t, d))
									: t.type === V.default.PLACEHOLDER
									? (d = a.formatPlaceholder(t, d))
									: t.value === ','
									? (d = a.formatComma(t, d))
									: t.value === ':'
									? (d = a.formatWithSpaceAfter(t, d))
									: t.value === '.'
									? (d = a.formatWithoutSpaces(t, d))
									: t.value === ';'
									? (d = a.formatQuerySeparator(t, d))
									: (d = a.formatWithSpaces(t, d)));
					}),
					d
				);
			}),
			(e.prototype.formatLineComment = function (a, d) {
				return this.addNewline(d + a.value);
			}),
			(e.prototype.formatBlockComment = function (a, d) {
				return this.addNewline(this.addNewline(d) + this.indentComment(a.value));
			}),
			(e.prototype.indentComment = function (a) {
				return a.replace(
					/\n/g,
					`
` + this.indentation.getIndent(),
			...
			(e.prototype.formatToplevelReservedWord = function (a, d) {
				return (
					this.indentation.decreaseTopLevel(),
					(d = this.addNewline(d)),
					this.indentation.increaseToplevel(),
					(d += this.equalizeWhitespace(a.value)),
					this.addNewline(d)
				);
			}),
			(e.prototype.formatNewlineReservedWord = function (a, d) {
				return this.addNewline(d) + this.equalizeWhitespace(a.value) + ' ';
			}),
			(e.prototype.equalizeWhitespace = function (a) {
				return a.replace(/\s+/g, ' ');
			}),
			(e.prototype.formatOpeningParentheses = function (a, d) {
				var t = [V.default.WHITESPACE, V.default.OPEN_PAREN, V.default.LINE_COMMENT];
				return (
					(0, Am.default)(t, this.previousToken().type) || (d = (0, Ve.default)(d)),
					(d += a.value),
					this.inlineBlock.beginIfPossible(this.tokens, this.index),
					this.inlineBlock.isActive() || (this.indentation.increaseBlockLevel(), (d = this.addNewline(d))),
					d
				);
			}),
			(e.prototype.formatClosingParentheses = function (a, d) {
				return this.inlineBlock.isActive()
					? (this.inlineBlock.end(), this.formatWithSpaceAfter(a, d))
					: (this.indentation.decreaseBlockLevel(), this.formatWithSpaces(a, this.addNewline(d)));
			}),
			(e.prototype.formatPlaceholder = function (a, d) {
				return d + this.params.get(a) + ' ';
			}),
			(e.prototype.formatComma = function (a, d) {
				return (
					(d = this.trimTrailingWhitespace(d) + a.value + ' '),
					this.inlineBlock.isActive() || /^LIMIT$/i.test(this.previousReservedWord.value)
						? d
						: this.addNewline(d)
				);
			}),
			(e.prototype.formatWithSpaceAfter = function (a, d) {
				return this.trimTrailingWhitespace(d) + a.value + ' ';
			}),
			(e.prototype.formatWithoutSpaces = function (a, d) {
				return this.trimTrailingWhitespace(d) + a.value;
			}),
			(e.prototype.formatWithSpaces = function (a, d) {
				return d + a.value + ' ';
			}),
			(e.prototype.formatQuerySeparator = function (a, d) {
				return (
					this.trimTrailingWhitespace(d) +
					a.value +
					`
`
				);
			}),
			(e.prototype.addNewline = function (a) {
				return (
					(0, Ve.default)(a) +
					`
` +
			...
			(e.prototype.trimTrailingWhitespace = function (a) {
				return this.previousNonWhitespaceToken().type === V.default.LINE_COMMENT
					? (0, Ve.default)(a) +
							`
`
					: (0, Ve.default)(a);
			...
			(e.prototype.previousNonWhitespaceToken = function () {
				for (var a = 1; this.previousToken(a).type === V.default.WHITESPACE; ) a++;
				return this.previousToken(a);
			}),
	...
	Pe.default = bm;
	q4.exports = Pe.default;
});
var G4 = o((jn, $4) => {
	var Vm = i1(),
		Pm = Vm['__core-js_shared__'];
	$4.exports = Pm;
});
var j4 = o((Yn, W4) => {
	var Wp = G4(),
		H4 = (function () {
			var e = /[^.]+$/.exec((Wp && Wp.keys && Wp.keys.IE_PROTO) || '');
...
var K4 = o((Kn, X4) => {
	var xm = Ip(),
		...
		$m = jp(),
		Gm = /[\\^$.*+?()[\]{}|]/g,
		Hm = /^\[object .+?Constructor\]$/,
		Wm = Function.prototype,
		jm = Object.prototype,
		Ym = Wm.toString,
		Xm = jm.hasOwnProperty,
		Km = RegExp(
			'^' +
				Ym.call(Xm)
					.replace(Gm, '\\$&')
...
var E0 = o((du, f0) => {
	var Yp = e0(),
		...
		wl = B1(Jp),
		w1 = v0;
	((Yp && w1(new Yp(new ArrayBuffer(1))) != c0) ||
		(Xp && w1(new Xp()) != s0) ||
		(Kp && w1(Kp.resolve()) != o0) ||
		(zp && w1(new zp()) != n0) ||
		(Jp && w1(new Jp()) != u0)) &&
...
var h0 = o((tu, T0) => {
	var Al = kp(),
		...
		Ll = '[object Set]',
		bl = Object.prototype,
		Vl = bl.hasOwnProperty;
	function Pl(e) {
		if (e == null) return !0;
		if (Ol(e) && (Dl(e) || typeof e == 'string' || typeof e.splice == 'function' || _l(e) || Cl(e) || gl(e)))
			return !e.length;
		var p = Rl(e);
		if (p == yl || p == Ll) return !e.size;
		if (Il(e)) return !Al(e).length;
		for (var a in e) if (Vl.call(e, a)) return !1;
		return !0;
	}
	T0.exports = Pl;
});
var w0 = o((iu, S0) => {
	var Ul = _e(),
		...
		Ml = RegExp(N0.source);
	function Bl(e) {
		return (e = Ul(e)), e && Ml.test(e) ? e.replace(N0, '\\$&') : e;
	}
	S0.exports = Bl;
});
var ie = o((Me, A0) => {
	...
	var Gl = (function () {
		function e(p) {
			$l(this, e),
				...
				(this.LINE_COMMENT_REGEX = this.createLineCommentRegex(p.lineCommentTypes)),
				(this.RESERVED_TOPLEVEL_REGEX = this.createReservedWordRegex(p.reservedToplevelWords)),
				(this.RESERVED_NEWLINE_REGEX = this.createReservedWordRegex(p.reservedNewlineWords)),
				(this.RESERVED_PLAIN_REGEX = this.createReservedWordRegex(p.reservedWords)),
				(this.WORD_REGEX = this.createWordRegex(p.specialWordChars)),
				(this.STRING_REGEX = this.createStringRegex(p.stringTypes)),
				(this.OPEN_PAREN_REGEX = this.createParenRegex(p.openParens)),
				(this.CLOSE_PAREN_REGEX = this.createParenRegex(p.closeParens)),
				(this.INDEXED_PLACEHOLDER_REGEX = this.createPlaceholderRegex(p.indexedPlaceholderTypes, '[0-9]*')),
				(this.IDENT_NAMED_PLACEHOLDER_REGEX = this.createPlaceholderRegex(
					p.namedPlaceholderTypes,
					'[a-zA-Z0-9._$]+',
				)),
				(this.STRING_NAMED_PLACEHOLDER_REGEX = this.createPlaceholderRegex(
					p.namedPlaceholderTypes,
					this.createStringPattern(p.stringTypes),
				));
		}
		return (
			(e.prototype.createLineCommentRegex = function (a) {
				return new RegExp(
					'^((?:' +
						a
							.map(function (d) {
								return (0, Ue.default)(d);
							})
							.join('|') +
						`).*?(?:
|$))`,
			...
			(e.prototype.createReservedWordRegex = function (a) {
				var d = a.join('|').replace(/ /g, '\\s+');
				return new RegExp('^(' + d + ')\\b', 'i');
			}),
			(e.prototype.createWordRegex = function () {
				var a = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
				return new RegExp('^([\\w' + a.join('') + ']+)');
			}),
			(e.prototype.createStringRegex = function (a) {
				return new RegExp('^(' + this.createStringPattern(a) + ')');
			}),
			(e.prototype.createStringPattern = function (a) {
				var d = {
					'``': '((`[^`]*($|`))+)',
					'[]': '((\\[[^\\]]*($|\\]))(\\][^\\]]*($|\\]))*)',
					'""': '(("[^"\\\\]*(?:\\\\.[^"\\\\]*)*("|$))+)',
			...
			(e.prototype.createParenRegex = function (a) {
				var d = this;
				return new RegExp(
					'^(' +
						a
							.map(function (t) {
								return d.escapeParen(t);
							})
							.join('|') +
						')',
					'i',
			...
			(e.prototype.escapeParen = function (a) {
				return a.length === 1 ? (0, Ue.default)(a) : '\\b' + a + '\\b';
			}),
			(e.prototype.createPlaceholderRegex = function (a, d) {
				if ((0, xl.default)(a)) return !1;
				var t = a.map(Ue.default).join('|');
				return new RegExp('^((?:' + t + ')(?:' + d + '))');
			}),
			(e.prototype.tokenize = function (a) {
				for (var d = [], t = void 0; a.length; )
					(t = this.getNextToken(a, t)), (a = a.substring(t.value.length)), d.push(t);
				return d;
			}),
			(e.prototype.getNextToken = function (a, d) {
				return (
					this.getWhitespaceToken(a) ||
					this.getCommentToken(a) ||
					this.getStringToken(a) ||
					this.getOpenParenToken(a) ||
					this.getCloseParenToken(a) ||
					this.getPlaceholderToken(a) ||
					this.getNumberToken(a) ||
					this.getReservedWordToken(a, d) ||
					this.getWordToken(a) ||
					this.getOperatorToken(a)
				);
			}),
			(e.prototype.getWhitespaceToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.WHITESPACE,
					regex: this.WHITESPACE_REGEX,
				});
			}),
			(e.prototype.getCommentToken = function (a) {
				return this.getLineCommentToken(a) || this.getBlockCommentToken(a);
			}),
			(e.prototype.getLineCommentToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.LINE_COMMENT,
					regex: this.LINE_COMMENT_REGEX,
				});
			}),
			(e.prototype.getBlockCommentToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.BLOCK_COMMENT,
					regex: this.BLOCK_COMMENT_REGEX,
				});
			}),
			(e.prototype.getStringToken = function (a) {
				return this.getTokenOnFirstMatch({ input: a, type: M.default.STRING, regex: this.STRING_REGEX });
			}),
			(e.prototype.getOpenParenToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.OPEN_PAREN,
					regex: this.OPEN_PAREN_REGEX,
				});
			}),
			(e.prototype.getCloseParenToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.CLOSE_PAREN,
					regex: this.CLOSE_PAREN_REGEX,
				});
			}),
			(e.prototype.getPlaceholderToken = function (a) {
				return (
					this.getIdentNamedPlaceholderToken(a) ||
					this.getStringNamedPlaceholderToken(a) ||
					this.getIndexedPlaceholderToken(a)
				);
			}),
			(e.prototype.getIdentNamedPlaceholderToken = function (a) {
			...
			(e.prototype.getStringNamedPlaceholderToken = function (a) {
				var d = this;
				return this.getPlaceholderTokenWithKey({
					input: a,
					regex: this.STRING_NAMED_PLACEHOLDER_REGEX,
					parseKey: function (i) {
						return d.getEscapedPlaceholderKey({ key: i.slice(2, -1), quoteChar: i.slice(-1) });
					},
				});
			}),
			(e.prototype.getIndexedPlaceholderToken = function (a) {
				return this.getPlaceholderTokenWithKey({
					input: a,
			...
			(e.prototype.getPlaceholderTokenWithKey = function (a) {
				var d = a.input,
					t = a.regex,
					i = a.parseKey,
					r = this.getTokenOnFirstMatch({ input: d, regex: t, type: M.default.PLACEHOLDER });
				return r && (r.key = i(r.value)), r;
			}),
			(e.prototype.getEscapedPlaceholderKey = function (a) {
				var d = a.key,
					t = a.quoteChar;
				return d.replace(new RegExp((0, Ue.default)('\\') + t, 'g'), t);
			}),
			(e.prototype.getNumberToken = function (a) {
				return this.getTokenOnFirstMatch({ input: a, type: M.default.NUMBER, regex: this.NUMBER_REGEX });
			}),
			(e.prototype.getOperatorToken = function (a) {
				return this.getTokenOnFirstMatch({ input: a, type: M.default.OPERATOR, regex: this.OPERATOR_REGEX });
			}),
			(e.prototype.getReservedWordToken = function (a, d) {
				if (!(d && d.value && d.value === '.'))
					return (
						this.getToplevelReservedToken(a) ||
						this.getNewlineReservedToken(a) ||
						this.getPlainReservedToken(a)
					);
			}),
			(e.prototype.getToplevelReservedToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.RESERVED_TOPLEVEL,
					regex: this.RESERVED_TOPLEVEL_REGEX,
				});
			}),
			(e.prototype.getNewlineReservedToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.RESERVED_NEWLINE,
					regex: this.RESERVED_NEWLINE_REGEX,
				});
			}),
			(e.prototype.getPlainReservedToken = function (a) {
				return this.getTokenOnFirstMatch({
					input: a,
					type: M.default.RESERVED,
					regex: this.RESERVED_PLAIN_REGEX,
				});
			}),
			(e.prototype.getWordToken = function (a) {
				return this.getTokenOnFirstMatch({ input: a, type: M.default.WORD, regex: this.WORD_REGEX });
			}),
			(e.prototype.getTokenOnFirstMatch = function (a) {
				var d = a.input,
					t = a.type,
					i = a.regex,
					r = d.match(i);
				...
				(e.prototype.format = function (a) {
					return (
						Zp ||
							(Zp = new Yl.default({
								reservedWords: Kl,
								reservedToplevelWords: zl,
								reservedNewlineWords: Jl,
								stringTypes: ['""', "''", '``', '[]'],
								openParens: ['('],
								closeParens: [')'],
						...
						new Wl.default(this.cfg, Zp).format(a)
					);
				}),
				e
			);
				...
				(e.prototype.format = function (a) {
					return (
						e2 ||
							(e2 = new as.default({
								reservedWords: ts,
								reservedToplevelWords: is,
								reservedNewlineWords: rs,
								stringTypes: ['""', "''", '``'],
								openParens: ['(', '[', '{'],
								closeParens: [')', ']', '}'],
								namedPlaceholderTypes: ['$'],
						...
						new es.default(this.cfg, e2).format(a)
					);
				}),
				e
			);
				...
				(e.prototype.format = function (a) {
					return (
						p2 ||
							(p2 = new ns.default({
								reservedWords: cs,
								reservedToplevelWords: vs,
								reservedNewlineWords: fs,
								stringTypes: ['""', "N''", "''", '``'],
								openParens: ['(', 'CASE'],
								closeParens: [')', 'END'],
								indexedPlaceholderTypes: ['?'],
						...
						new ss.default(this.cfg, p2).format(a)
					);
				}),
				e
			);
				...
				(e.prototype.format = function (a) {
					return (
						a2 ||
							(a2 = new Ss.default({
								reservedWords: As,
								reservedToplevelWords: Rs,
								reservedNewlineWords: gs,
								stringTypes: ['""', "N''", "''", '``', '[]'],
								openParens: ['(', 'CASE'],
								closeParens: [')', 'END'],
								indexedPlaceholderTypes: ['?'],
						...
						new hs.default(this.cfg, a2).format(a)
					);
				}),
				e
			);
...
var d2 = o(($e, U0) => {
	...
	$e.default = {
		format: function (p, a) {
			switch (((a = a || {}), a.language)) {
				case 'db2':
					return new _s.default(a).format(p);
				case 'n1ql':
					return new Cs.default(a).format(p);
				case 'pl/sql':
					return new Ls.default(a).format(p);
				case 'sql':
				case void 0:
					return new Vs.default(a).format(p);
				default:
					throw Error('Unsupported SQL dialect: ' + a.language);
			}
		},
	};
	U0.exports = $e.default;
});
var B0 = o((ru, M0) => {
	M0.exports = {
...
var k0 = o((mu, x0) => {
	var y = B0(),
		{ getFullEntityName: F0 } = K1();
	x0.exports = e => {
		let { assignTemplates: p } = e.require('@hackolade/ddl-fe-utils');
		return {
			dropView(a) {
				return p(y.dropView, { name: a });
			},
			dropTableIndex(a) {
				return a ? p(y.dropTableIndex, { name: a }) : '';
			},
			dropTable(a) {
				return p(y.dropTable, { name: a });
			},
			alterTableName({ oldName: a, newName: d }) {
				return !a || !d ? '' : p(y.alterTableName, { oldName: a, newName: d });
			},
			alterTableColumnName({ collectionName: a, columns: d } = {}) {
				return a
					? d
							.map(({ oldName: i, newName: r }) =>
								i && r ? p(y.alterTableColumnName, { collectionName: a, oldName: i, newName: r }) : '',
							)
							.filter(Boolean)
					: '';
			},
			alterTableProperties({ dataProperties: a, name: d }) {
				if (!d) return [];
				let { add: t = '', drop: i = '' } = a,
					r = [];
				return (
					t.length && (r = r.concat(p(y.setTableProperties, { name: d, properties: t }))),
					i.length && (r = r.concat(p(y.unsetTableProperties, { name: d, properties: i }))),
					r
				);
			},
			setTableProperties({ name: a, properties: d } = {}) {
				return !a || !d ? '' : p(y.setTableProperties, { name: a, properties: d });
			},
			unsetTableProperties({ name: a, properties: d } = {}) {
				return !a || !d ? '' : p(y.unsetTableProperties, { name: a, properties: d });
			},
			addTableColumns({ name: a, columns: d }) {
				return !a || !d ? '' : p(y.addTableColumns, { name: a, columns: d });
			},
			dropDatabase(a) {
				return a ? p(y.dropDatabase, { name: a }) : '';
			},
			alterSerDeProperties({ properties: a, serDe: d, name: t }) {
				if (!t || !d) return '';
				let i = a ? p(y.serDeProperties, { properties: a }) : '';
				return p(y.alterSerDeProperties, { name: t, serDeProperties: i, serDe: d });
			},
			alterView({
				dataProperties: a,
				dbName: d,
				fullName: t,
				rename: { newName: i, oldName: r },
				selectStatement: m,
			}) {
				let { add: l = '', drop: s = '' } = a || {},
					n = [];
				if (i !== r && !!i && !!r) {
					let u = F0(d, i),
						c = F0(d, r);
					n = n.concat(p(y.alterViewName, { oldName: c, newName: u }));
				}
				return (
					t &&
						(l.length && (n = n.concat(p(y.setViewProperties, { name: t, properties: l }))),
						s.length && (n = n.concat(p(y.unsetViewProperties, { name: t, properties: s }))),
						m && (n = n.concat(p(y.alterViewStatement, { name: t, query: m })))),
					n
				);
			},
		};
...
var $0 = o((lu, q0) => {
	var { getAddContainerScript: Ps, getDeleteContainerScript: Us, getModifyContainerScript: Ms } = rd(),
		{
			getAddCollectionsScripts: Bs,
			getDeleteCollectionsScripts: Fs,
			getModifyCollectionsScripts: xs,
			getDeleteColumnsScripts: ks,
			getAddColumnsScripts: qs,
			getModifyColumnsScripts: $s,
		} = ud(),
		{ getAddViewsScripts: Gs, getDeleteViewsScripts: Hs, getModifyViewsScripts: Ws } = Ad(),
		{ DROP_STATEMENTS: js } = Dp(),
		{ commentDeactivatedStatements: Ys } = W(),
		Xs = d2(),
		k = (e, p, a) =>
			[]
				.concat(e.properties?.[p]?.properties?.[a]?.items)
				.filter(Boolean)
				.map(d => Object.values(d.properties)[0]),
		Ks = (e, p) => {
			let a = k(e, 'containers', 'added').map(Ps),
				d = k(e, 'containers', 'deleted').map(Us(p)),
				t = k(e, 'containers', 'modified').flatMap(Ms(p));
			return [...a, ...d, ...t];
		},
		zs = (e, p, a) => {
			let d = (u, c, v) => u.filter(f => f.compMod?.[c]).flatMap(v),
				t = (u, c) => u.filter(v => !v.compMod).flatMap(c),
				i = d(k(e, 'entities', 'added'), 'created', Bs(p)),
				r = d(k(e, 'entities', 'deleted'), 'deleted', Fs(a)),
				m = d(k(e, 'entities', 'modified'), 'modified', xs(p, a)),
				l = t(k(e, 'entities', 'added'), qs(p, a)),
				s = t(k(e, 'entities', 'deleted'), ks(p, a)),
				n = t(k(e, 'entities', 'modified'), $s(p, a));
			return [...i, ...r, ...m, ...l, ...s, ...n];
		},
		Js = (e, p) => {
			let a = (m, l, s) =>
					m
						.map(n => ({ ...n, ...(n.role || {}) }))
						.filter(n => n.compMod?.[l])
						.map(s),
				d = (m, l) =>
					m
						.map(s => ({ ...s, ...(s.role || {}) }))
						.filter(s => !s.compMod?.created && !s.compMod?.deleted)
						.flatMap(l),
				t = a(k(e, 'views', 'added'), 'created', Gs),
				i = a(k(e, 'views', 'deleted'), 'deleted', Hs(p)),
				r = d(k(e, 'views', 'modified'), Ws(p));
			return [...t, ...i, ...r];
		},
		Qs = (e, p, a, d) => {
			let t = k0()(d),
				...
				l = i
					...
					.filter(Boolean)
					.map(s => s.trim());
			return (l = Zs(l, a)), eo(l);
		},
		Zs = (e, p) => {
			let { additionalOptions: a = [] } = p.options || {};
			return (a.find(t => t.id === 'applyDropStatements') || {}).value
				? e
				: e.map(t => (js.some(r => t.includes(r)) ? Ys(t, !1) : t));
		},
		eo = e =>
			Xs.format(
...
`);
	q0.exports = { getAlterScript: Qs };
});
var { setDependencies: t2, dependencies: i2 } = q(),
	{ getDatabaseStatement: G0 } = We(),
	{ getTableStatement: H0 } = Qe(),
	{ getIndexes: W0 } = dp(),
	{ getViewScript: po } = tp(),
	{ getCleanedUrl: j0 } = W(),
	Q0,
	...
	{ getAlterScript: Y0 } = $0(),
	ro = d2(),
	{ DROP_STATEMENTS: mo } = Dp(),
	X0 = ({ lodash: e }) => (Q0 = e);
module.exports = {
	generateScript(e, p, a, d) {
		try {
			t2(d), X0(i2);
			let t = JSON.parse(e.jsonSchema),
				i = JSON.parse(e.modelDefinitions),
				r = JSON.parse(e.internalDefinitions),
				m = JSON.parse(e.externalDefinitions),
				l = e.containerData,
				s = e.entityData,
				n = e.modelData[0].dbVersion.startsWith('3'),
				u = !e.modelData[0].dbVersion.startsWith('1'),
				c = '';
			if (e.isUpdateScript) c = Y0(t, [i, r, m], e, d);
			else {
				let v = G0(l),
					f = H0(l, s, t, [i, r, m], null, n, u);
				c = K0(v, f, W0(l, s, t, [i, r, m]));
			}
			a(null, c);
		} catch (t) {
			p.log('error', { message: t.message, stack: t.stack }, 'DeltaLake Forward-Engineering Error'),
				setTimeout(() => {
					a({ message: t.message, stack: t.stack });
				}, 150);
		}
	},
	generateContainerScript(e, p, a, d) {
		try {
			t2(d), X0(i2);
			let t = e.containerData,
				i = JSON.parse(e.modelDefinitions),
				r = JSON.parse(e.externalDefinitions),
				m = z0(e.entities, e.jsonSchema),
				l = z0(e.entities, e.internalDefinitions),
				s = e.modelData[0].dbVersion.startsWith('3'),
				n = !e.modelData[0].dbVersion.startsWith('1');
			if (e.isUpdateScript) {
				let h = Q0.first(Object.values(m)) || {},
					L = Y0(h, [i, l, r], e, d);
				a(null, L);
				return;
			}
			let u = G0(t),
				c = e.views.map(h => {
					let T = JSON.parse(e.jsonSchema[h] || '{}');
					return po({
						schema: T,
						viewData: e.viewData[h],
						containerData: e.containerData,
						collectionRefsDefinitionsMap: e.collectionRefsDefinitionsMap,
						isKeyspaceActivated: !0,
					});
				});
			c = c.filter(h => !i2.lodash.isEmpty(h));
			let v = e.entities.reduce((h, T) => {
					let L = [t, e.entityData[T], m[T], [l[T], i, r], !0],
						B = H0(...L, null, s, n);
					return h.concat([B, W0(...L)]);
				}, []),
				f = K0(u, ...v, ...c);
			a(null, f);
		} catch (t) {
			p.log('error', { message: t.message, stack: t.stack }, 'Hive Forward-Engineering Error'),
				setTimeout(() => {
					a({ message: t.message, stack: t.stack });
				}, 150);
		}
	},
	async applyToInstance(e, p, a, d) {
		p.clear(), J0('info', e, p);
		let t = {
			host: j0(e.host),
			clusterId: e.clusterId,
			accessToken: e.accessToken,
			applyToInstanceQueryRequestTimeout: e.applyToInstanceQueryRequestTimeout,
			script: e.script,
		};
		try {
			await ao.fetchApplyToInstance(t, p), a();
		} catch (i) {
			p.log('error', { message: i.message, stack: i.stack, error: i }, 'Apply to instance'),
				a({ message: i.message, stack: i.stack });
		}
	},
	async testConnection(e, p, a) {
		try {
			J0('Test connection FE', e, p);
			let d = { host: j0(e.host), clusterId: e.clusterId, accessToken: e.accessToken },
				t = await to.getClusterStateInfo(d, p);
			p.log('info', t, 'Cluster state info'),
				t.isRunning ||
					a({ message: `Cluster is unavailable. Cluster status: ${t.state}`, type: 'simpleError' }),
				a();
		} catch (d) {
			p.log('error', { message: d.message, stack: d.stack, error: d }, 'Test connection FE'),
				a({ message: d.message, stack: d.stack });
		}
	},
	isDropInStatements(e, p, a, d) {
		let t = (i, r = '') => {
			a(
				i,
				mo.some(m => r.includes(m)),
			);
		};
		try {
			t2(d),
				e.level === 'container'
					? this.generateContainerScript(e, p, t, d)
					: e.level === 'entity' && this.generateScript(e, p, t, d);
		} catch (i) {
			t({ message: i.message, stack: i.stack });
		}
	},
};
var K0 = (...e) => {
		let p = e.filter(a => a).join(`
...
`
	...
	z0 = (e, p) =>
		e.reduce((a, d) => {
			try {
				return Object.assign({}, a, { [d]: JSON.parse(p[d]) });
			} catch {
				return a;
			}
		}, {}),
	J0 = (e, p, a) => {
		a.clear(), a.log('info', io.getSystemInfo(p), e), a.log('info', p, 'connectionInfo', p.hiddenKeys);
	};
